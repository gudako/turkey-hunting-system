    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If PictureBox1.Tag = 5 Then
            ...
            If Form1.picturebox2.Tag = 25 Then
                ...
                MsgBox("Nobody know what happened between them... But the chaos has been formed in silence.", 0,
                       "Mystery")
            End If
        ElseIf PictureBox1.Tag = 12 Then
            ...
            If Form1.picturebox2.Tag = 30 Then
                ...
                MsgBox(
                    "The witch is quite harmful. All these chaos are formed by the witch. She is the real mastermind behind all of these.",
                    0, "Mystery")
                ...
                MsgBox("The next class is general technology. The classroom is on floor4, beyond the biology lab.", 0,
                       "Next class")
        ...
        ElseIf PictureBox1.Tag = 17 Then
            ...
            If Form1.picturebox2.Tag = 37 Then
                ...
                MsgBox(
                    "The reality cannot be changed anymore. Their tragedy is doomed. Except going to the past, or things're impossible.",
                    0, "Their Doom")
            End If
        ...
        Else
            If Form1.mute.Checked = False Then _
                My.Computer.Audio.Play(
                    My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound40.wm")
            ChangeImage(PictureBox1.Tag + 1)
        End If
    End Sub

    Public Sub ChangeImage(code As Integer)
        PictureBox1.Tag = code
        PictureBox1.BackColor = Color.Transparent
        PictureBox1.Image =
            Image.FromFile(
                My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\intro" & code & ".wm")
        If Form1.mute.Checked = False And code < 18 Then _
            My.Computer.Audio.Play(
                My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\voice" & code & ".wm")
    End Sub
End Class