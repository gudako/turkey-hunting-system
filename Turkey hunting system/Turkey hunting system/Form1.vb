...
Public Class Form1
    ...
    Private MovingItem As PictureBox = New PictureBox With {.Visible = False}
    ...
    Private TipBox As Label = New Label With {.Location = New Point(0, 0), .Font = New Font("微软雅黑", 16.2!, FontStyle.Regular, GraphicsUnit.Point, 134), .BackColor = Color.Black, .ForeColor = Color.White, .Visible = True}
    Private ImportantTip As Boolean = False, ResponseCode As Integer = 0, DeathFlag As Boolean = False, Temp1 As Boolean = True, MoveSpeed As Integer = 1, MoveHydrogenPeroxide As Boolean = False, MP3mixture As Boolean = False
    Friend DeathFlagNum As Integer = 0, BackgroundVolume As Integer = 67, Drawer As PictureBox() = {drawer1, drawer2, drawer3, drawer4}, Unable As Boolean = False
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If step_ = 0 Then
            If MsgBox("You can exit, but it require a hunted turkey, do you have it?", vbYesNo + vbExclamation, "Exit the system") = vbYes Then
        ...
        ElseIf step_ = 7 Then
            step_ = 8
            If Not mute.Checked Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound5.wm")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If step_ = 0 Then
            If MsgBox("Are you ready for hunting the turkey?", vbQuestion + vbYesNo, "Get ready!") = vbYes Then
                ...
                content.Text = "To hunt the turkey, we surely should know his location, probably he is in class now. Enter which class contains the turkey."
                topic.Text = "Intro"
                topic.Visible = True
                DifTip.Visible = True
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        If step_ = 3 Then
            ...
            Form4.Show()
            Form4.start("There're teachers in the office, probably turkey is in it. Shall we rush into it?", "Rush it!", 0, "Go out quietly.", 1)
        ElseIf step_ = 4 Then
    ...
    Public Sub Choosing(ByVal code As Integer)
        If code = 0 Then
            Form5.Show()
        ...
        ElseIf code = 3 Then
            MsgBox("Then we should resume searching the turkey, there's other three places, maybe the turkey is in them. It's nest in toilet, it means the turkey is near.", 64, "Resume")
    ...
    Public Sub TimeDone(ByVal code As Integer)
        If code = 0 Then
        ...
        ElseIf code = 4 Then
            ...
            Else
                If required_labkey Then
                    Form4.start("No turkey. However, on the playground, that's the lab key what we required! Shall we pick it?", "Pick it.", 4, "Keep it on ground.", 5)
                Else
        ...
        ElseIf code = 5 Then
            If picturebox1.Tag = 12 Then
                picturebox1.Tag = 13
                disappear()
                picturebox1.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene9.wm")
                place9_1.Visible = True
                MsgBox("The sound came from the building just now, rush it!", 48, "End of Chapter1")
            Else
                disappear()
                picturebox1.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene2.wm")
        ...
        ElseIf code = 6 Then
            disappear()
            picturebox1.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene1.wm")
        ...
        ElseIf code = 9 Then
            disappear()
            picturebox1.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene3.wm")
        ...
        ElseIf code = 10 Then
            ...
            Else
                shield_level = 1
                Form11.start(5, "New shield!", "You find a light aluminic shield inside the area! Your defence'll be powered up.", "Done.")
            End If
        ElseIf code = 11 Then
            place1_4.Tag = 1
            MsgBox("!!", 48, "!!")
        ...
        ElseIf code = 12 Then
            disappear()
            picturebox1.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene6.wm")
        ...
        ElseIf code = 13 Then
            disappear()
            picturebox1.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene5.wm")
    ...
    Public Sub GameOver(ByVal cause As String)
        mute.Enabled = False
        Hide()
        Form4.Hide()
        Form5.Hide()
        ...
        If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound7.wm")
    End Sub

    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        If step_ = 3 Then
            If MsgBox("Maybe he is in toilet, we can rush into it!", MsgBoxStyle.Question + vbYesNo, "The toilet") = vbYes Then
                Form5.Show()
                Form5.start(1, "Rushing into the toilet.", 10)
            End If
        ElseIf step_ = 4 Then
            If MsgBox("The playground may be a bit far, do you still want to go?", MsgBoxStyle.Question + vbYesNo, "The playground") = vbYes Then
    ...
    Public Sub Information(ByVal code As Integer)
        If code = 0 Then
            Form4.Show()
        ...
        ElseIf code = 3 Then
            If hen_egg Then
                Form4.start("You have both two eggs, do you want to put them into the door and open it now?", "Open.", 7, "Do not open.", -1)
            Else
                Form6.start("You just have the turkey egg but the another one, so you can't open it.", -1)
            End If
        ElseIf code = 4 Then
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound9.wm")
            Form4.start("Suddenly, a rabbit rushes out with something, do you want to snatch the thing?", "Snatch it!", 8, "Get away.", -1)
        ElseIf code = 5 Then
        ...
        ElseIf code = 10 Then
            Form11.start(10, "Corona ball!", "Oh my god! The English teacher has set corona ball near the door, it starts to attack! You must defeat it or it won't stop.", "Fight!")
        ElseIf code = 11 Then
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound5.wm")
        ...
        ElseIf code = 15 Then
            Form11.start(16, "Assist!", "Mr.Duck is going to support you, he can eat murlocs fast. You'd battle together!", "To battle!")
        ElseIf code = 16 Then
        ...
        ElseIf code = 20 Then
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound35.wm")
        ...
        ElseIf code = 25 Then
            Form6.start("May you'd go up second floor on right side, just now I heard witch's laughter and turkey voice.", 26)
        ElseIf code = 26 Then
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        ElseIf step_ = 4 Then
            ...
            Else
                required_labkey = True
                Form6.start("There's a big turkey egg in the lab, but there's also a big lock on the door which blocked us from going inside.", -1)
            End If
        End If
    End Sub
    ...
    Public Sub AfterBattle(ByVal code As Integer)
        ...
        ElseIf code = 2 Then
            revive += 1
            Form11.start(2, "New item!", "You get a Six God revival potion from the rabbit. You can use it when you get defeated in battle.", "Yes.")
            music.settings.volume = BackgroundVolume
            music.settings.volume = BackgroundVolume
            music.URL = My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\music1.wm"
        ElseIf code = 3 Then
        ...
        ElseIf code = 5 Then
            Dim random_ As Random = New Random(Date.Now.Millisecond)
        ...
        ElseIf code = 6 Then
            ...
            music.settings.volume = BackgroundVolume
            music.URL = My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\music1.wm"
            MsgBox("The solar corona ball with R.X. power is broken up, you get a power of solar light. Now you can go to the class now.")
        ElseIf code = 7 Then
        ...
        ElseIf code = 12 Then
            ...
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound27.wm")
            Form11.start(17, "Mixture creation!", "Hahahahahaha!! Ao(ge)ao(ge)ao(ge)ao(ge)ao(ge)ao(ge)ao(ge)aoaoao(gegege)!!!", "Next→")
        ElseIf code = 13 Then
        ...
        ElseIf code = 14 Then
            ...
            MsgBox("Well done! Let's go out from the terrifying biology lab. The turkey is still near.", 64, "Well Done!")
        ElseIf code = 15 Then
        ...
        ElseIf code = 16 Then
            ...
            music.settings.volume = BackgroundVolume
            music.URL = My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\music1.wm"
            MsgBox("You've got 2 things:" & vbCrLf & "Murloc sword," & vbCrLf & "1x SixGod Curative potion.", 64, "After battle")
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound5.wm")
        ...
        ElseIf code = 28 Then
            ...
            MsgBox("You get three things:" & vbCrLf & "Dragon paw" & vbCrLf & "Dragon armor shield" & vbCrLf & "Magic: Homework generator", 0, "Weapon&shield")
            actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image6.wm")
        ...
        ElseIf code = 30 Then
            ...
            actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image2.wm")
    ...
    Friend Sub SetHeight(ByVal height As Integer, code As Integer)
    ...
    End Sub
    Private Sub AfterSetting(ByVal code As Integer)
        If code = 0 Then
            step_ = 10
            ...
            picturebox1.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene1.wm")
            content.Text = "Please select a place to search the turkey." & vbCrLf & vbCrLf & "The sound ensures the turkey is in the school."
            topic.Text = "Chapter1"
            topic.Visible = True
            DifTip.Visible = True
            RemoveTitle.Enabled = True
    ...
    Private Sub place3_5_Click(sender As Object, e As EventArgs) Handles place3_5.Click
        If step_ = 10 Then
            If (picturebox1.Tag = 8 Or picturebox1.Tag = 9) And place3_5.Tag = 0 Then
                place3_5.Tag = 1
                heal += 2
                Form11.start(11, "Curative potion", "You find two bottles of curative potion near Mr.Duck's seat.", "Next")
        ...
        If step_ = 10 Then
            If place3_4.Tag = 1 Then
                If destroy_nest Then
                    Form4.start("There's a hen egg on the ground! What did it happen? Shall we pick it?", "Pick it.", 6, "Ignore.", -1)
                Else
                    Form4.start("There's a hen egg in the turkey nest! What did it happen? Shall we pick it?", "Pick it.", 6, "Ignore.", -1)
                End If
            ElseIf place3_4.Tag = 0 Then
                If six_god Then
                    Form11.Show()
                    Form11.start(0, "Unable to enter.", "The toilet becomes too smelly! Mortals cannot bear it.", "Go out.", "Use Six God to dispel.")
                Else
                    Form11.Show()
                    Form11.start(0, "Unable to enter.", "The toilet becomes too smelly! Mortals cannot bear it.", "Go out.")
                End If
    ...
    Private Sub place3_3_Click(sender As Object, e As EventArgs) Handles place3_3.Click
        If step_ = 10 Then
            If picturebox1.Tag = 12 Then
                MsgBox("It's unimportant to search here, go to the playground from another series of stairs.", 0, "Useless.")
            Else
    ...
    Private Sub place1_1_Click(sender As Object, e As EventArgs) Handles place1_1.Click
        ...
        ElseIf place1_1.Tag = 1 Then
            If MsgBox("The stairs'll lead you to the underground library.", vbOKCancel + vbQuestion, "Down to library") = vbOKCancel Then
    ...
    Private Sub place1_2_Click(sender As Object, e As EventArgs) Handles place1_2.Click
        If step_ = 10 Then
            If MsgBox("You'll go up from here to teaching building.", vbOKCancel + vbQuestion, "Change scene") = vbOK Then
    ...
    Private Sub place2_1_Click(sender As Object, e As EventArgs) Handles place2_1.Click
        If step_ = 10 Then
            If MsgBox("You'll go up the ground from library.", vbOKCancel + vbQuestion, "Up to ground") = vbOKCancel Then
    ...
    Private Sub place2_3_Click(sender As Object, e As EventArgs) Handles place2_3.Click
        If step_ = 10 Then
            ...
            Else
                Form11.start(4, "Witch's book!", "There's a witch's book on the counter! It looks strange! Do you want to take it?", "No.", "Yes.")
            End If
        End If
    End Sub
    Private Sub place2_2_Click(sender As Object, e As EventArgs) Handles place2_2.Click
        If step_ = 10 Then
            ...
            Else
                Form4.start("You may get detected if someone finds you. Do you still want to get inside?", "Risk it!", 9, "Avoid.", -1)
            End If
        End If
    End Sub
    ...
    Private Sub place1_4_Click(sender As Object, e As EventArgs) Handles place1_4.Click
        If step_ = 10 Then
            disappear()
            picturebox1.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene4.wm")
    ...
    Private Sub place4_1_Click(sender As Object, e As EventArgs) Handles place4_1.Click
        If step_ = 10 Then
            ...
            Else
                If picturebox1.Tag = 9 And defeat_hen = False Then MsgBox("We'll catch up with the shadow.", 64, "Speed up!")
                disappear()
                picturebox1.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene2.wm")
                place1_1.Visible = True
                place1_2.Visible = True
                ...
                If picturebox1.Tag = 9 Then
                    If defeat_hen = False Then
                        ...
                        Form6.start("The hen is roaring to you! She wants to fight and report your matters to the teacher.", 6)
                    End If
                End If
            End If
        End If
    ...
    Private Sub place4_2_Click(sender As Object, e As EventArgs) Handles place4_2.Click
        If step_ = 10 Then
            ...
            If picturebox1.Tag = 0 Then
                picturebox1.Tag = 1
                MsgBox("The turkey isn't here, surely he is on floor three, go upstairs and catch it!", 48, "Turkey is out there somewhere..")
            End If
        End If
    End Sub
    Private Sub place3_2_Click(sender As Object, e As EventArgs) Handles place3_2.Click
        If step_ = 10 Then
            ...
            ElseIf picturebox1.Tag >= 10 Then
                ...
                picturebox1.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene8.wm")
            Else
    ...
    Private Sub place5_2_Click(sender As Object, e As EventArgs) Handles place5_2.Click
        If step_ = 10 Then
            ...
            If picturebox1.Tag = 4 Then
                picturebox1.Tag = 5
                MsgBox("Suddenly, a big shadow flapped and rushed near you, we don't know what's that thing, but it's very probable it's the turkey.")
                Form11.start(6, "Black shadow!", "It has run to teaching building! Do you want to catch up with it?", "Still go to another exit.", "Of course: catch up!")
            End If
        End If
    End Sub
    Private Sub place5_1_Click(sender As Object, e As EventArgs) Handles place5_1.Click
        If step_ = 10 Then
            If picturebox1.Tag = 1 Then
                picturebox1.Tag = 2
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound11.wm")
    ...
    Private Sub place4_3_Click(sender As Object, e As EventArgs) Handles place4_3.Click
        If step_ = 10 Then
            ...
            End If
            disappear()
            picturebox1.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene7.wm")
            ...
            If picturebox1.Tag = 6 Then
                ...
                Form11.start(7, "New magic!", "You get a water egg which can water, it seems is which the small black hen lost on ground.", "Get it!")
            End If
        End If
    End Sub
    ...
    Private Sub place7_1_Click(sender As Object, e As EventArgs) Handles place7_1.Click
        If step_ = 10 Then
            ...
            If picturebox1.Tag = 7 Then
                picturebox1.Tag = 8
                Form6.start("There's no turkey, the shadow maybe is the turkey. Maybe he is in class now, go back the class.", -1)
            End If
        End If
    End Sub
    ...
    Private Sub place8_4_Click(sender As Object, e As EventArgs) Handles place8_4.Click
        If step_ = 10 Then
            If MsgBox("There're many things inside the desk, do you want to search things in it?", 32 + vbYesNo, "Massive things") = vbYes Then
    ...
    Private Sub place8_5_Click(sender As Object, e As EventArgs) Handles place8_5.Click
        If step_ = 10 Then
            If picturebox1.Tag = 10 Or picturebox1.Tag = 11 Then
                ...
                Else
                    Form6.start("The next class is Mr.Duck's class. Now the turkey is outside, rush out the door and catch it fast.", -1)
                End If
            Else
    ...
    Friend Sub Scene1Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene10.wm")
    ...
    Private Sub Scene2Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene11.wm")
    ...
    Private Sub Scene3Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene12.wm")
    ...
    Private Sub Scene4Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene13.wm")
    ...
    Friend Sub Scene5Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene14.wm")
    ...
    Private Sub Scene6Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene15.wm")
    ...
    Private Sub Scene7Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene16.wm")
    ...
    Private Sub Scene8Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene17.wm")
    ...
    Private Sub Scene9Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene18.wm")
    ...
    Private Sub Scene10Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene19.wm")
    ...
    Private Sub Scene11Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene20.wm")
    ...
    Private Sub Scene12Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene21.wm")
    ...
    Private Sub Scene13Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene22.wm")
    ...
    Friend Sub Scene14Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene23.wm")
    ...
    Private Sub Scene15Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene24.wm")
    ...
    Private Sub Scene16Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene25.wm")
    ...
    Friend Sub Scene17Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene26.wm")
    ...
    Private Sub Scene18Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene27.wm")
    ...
    Private Sub Scene19Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene28.wm")
    ...
    Private Sub Scene20Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene29.wm")
        If place12_1.Tag > 0 Then place12_1.Visible = True
        If place12_2.Tag > 0 Then place12_2.Visible = True
        If place12_3.Tag > 0 Then place12_3.Visible = True
        If place12_4.Tag > 0 Then place12_4.Visible = True
    ...
    Private Sub Scene21Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene30.wm")
    ...
    Private Sub Scene22Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene31.wm")
    ...
    Private Sub Scene23Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene32.wm")
    ...
    Private Sub Scene24Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene33.wm")
    ...
    Private Sub Scene25Appears()
        ...
        End If
        Disappear1()
        picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene34.wm")
        ...
        If items.Items.Contains("Physics lab key") Then
            If CostPower(5) Then
                ...
                If picturebox2.Tag = 23 Then
                    picturebox2.Tag = 24
                    If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound39.wm")
                    MsgBox("Suddenly, you saw the rooster speedly rushed over you! And jumped out the window.", 0, "Oh my god.")
                    MsgBox("When he was jumping out, he was carrying a big plastic bag with full of worms and worm liquid..", 0, "Then")
                End If
            End If
        Else
    ...
    Private Sub place01_1_Click(sender As Object, e As EventArgs) Handles place01_1.Click
        If CostPower(25) Then
            ...
            If picturebox2.Tag = 0 Then
                ...
                Form11.start(12, "Beware!", "There'll be your physical power, every action costs power to do. The power'll be restored while time is passing.", "I know.")
            End If
        End If
    End Sub
    ...
    Private Sub place03_3_Click(sender As Object, e As EventArgs) Handles place03_3.Click
        If OnFire And place03_3.Tag = 1 Then
            If items.Items.Contains("cleaner") Then
                Form11.start(34, "Sodium cyanide", "Large bottles of NaCN on the path. There is no doubt that the bottles were then put on a train for 411.", "Keep away.", "Pick up and eat.", "Use cleaner to clear.")
            Else
                Form11.start(34, "Sodium cyanide", "Large bottles of NaCN on the path. There is no doubt that the bottles were then put on a train for 411.", "Keep away.", "Pick up and eat.")
            End If
        Else
            ...
            Else
                If CostPower(3) Then
                    If items.Items.Contains("Caesium") Then
                        Form4.start("The door of the building is blocked by huge stones.", "Throw Caesium.", 12, "Go back.", -1)
                    Else
                        Form6.start("The door of the building is blocked by huge stones that you have no way to go out.", -1)
                    End If
                End If
            End If
        End If
    ...
    Private Sub place03_2_Click(sender As Object, e As EventArgs) Handles place03_2.Click
        ...
        If CostPower(7) Then
            ...
            Else
                If picturebox2.Tag = 6 Then
                    MsgBox("Yes, it's here! This time the turkey cannot run anymore, because the back door is closed and locked.", 64, "Good Job.")
                End If
                Scene6Appears()
                If picturebox2.Tag = 6 Then
                    picturebox2.Tag = 7
    ...
    Private Sub place03_5_Click(sender As Object, e As EventArgs) Handles place03_5.Click
        If CostPower(30) Then
            ...
            If picturebox2.Tag = 2 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound26.wm")
                MsgBox("No... It's not the turkey's sound... It is murloc!", 0, "Coincidence!")
                Form11.start(13, "All of a sudden", "Suddenly a murloc cried ""mlgr~mlgr~~mlgr~"" and rushes out from the biology lab! It seems very, very insane.", "Fight!", "Avoid away.")
            End If
        End If
    End Sub
    Private Sub place04_3_Click(sender As Object, e As EventArgs) Handles place04_3.Click
        If OnFire And place04_3.Tag = 1 Then
            ...
            If items.Items.Contains("Magic dispeller") Then
                If MsgBox("You can use magic dispeller to dispel the magic shield", vbYesNo, "Magic dispeller") = vbYes Then
        ...
        If CostPower(15) Then
            If picturebox2.Tag = 5 Then
                If Not mute.Checked Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound31.wm")
    ...
    Private Sub place02_3_Click(sender As Object, e As EventArgs) Handles place02_3.Click
        If picturebox2.Tag >= 14 Then
            If CostPower(20) Then
                If picturebox2.Tag = 14 Then
                    MsgBox("Yes, it's here! The big smelly milk cow has given us the key so that we can unlock the door.", 0, "Unlock Door")
                End If
                Scene7Appears()
                If picturebox2.Tag = 14 Then
                    picturebox2.Tag = 15
                    MsgBox("It's too smelly inside. What a smelly milk giving place.", 0, "Smelly place")
                    MsgBox("The cow said there was witch and turkey's sound coming out. Let's go to floor 3 and find the fact.", 0, "Discover the Fact")
                End If
            End If
        Else
        ...
        End If
    End Sub
    Private Function CostPower(ByVal cost As Integer)
    ...
    Private Sub place04_1_Click(sender As Object, e As EventArgs) Handles place04_1.Click
        If picturebox2.Tag = 3 Then
            picturebox2.Tag = 4
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound26.wm")
            Form11.start(14, "Murlocs rush!", "Massive mad murlocs rush out from inside and started attacking! What the hell of it!", "Oh my god!")
        Else
            If CostPower(4) Then
                ...
                If picturebox2.Tag = 11 Then
                    ...
                    Form11.start(22, "Big milk cow", "Our big milk cow is sitting on ground with few holes on its body! What happened?", "Next")
    ...
    Private Sub place05_1_Click(sender As Object, e As EventArgs) Handles place05_1.Click
        If picturebox2.Tag = 4 Then
            ...
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound25.wm")
        ...
        ElseIf picturebox2.Tag = 13 Then
            If MsgBox("Go out?", vbQuestion + vbYesNo, "Request") = vbYes Then
                picturebox2.Tag = 14
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound37.wm")
                ...
                MsgBox("What happened to our cow! It's the witch making ghost! But she just laughed and disappeared, we don't know what the magic she did cast on our cow.", 0, "Big smelly milk cow")
                MsgBox("Whatever the fact is... You must defeat the cow and calm it down. Or you'll be flattened by the cow.")
                Hide()
                Form7.Show()
    ...
    Private Sub place07_3_Click(sender As Object, e As EventArgs) Handles place07_3.Click
        ...
        ElseIf items.Items.Contains("Nitric acid") Then
            Form11.start(26, "Worms", "There're massive worms inside, we can hardly pass through.", "Oh yes.", "Splash Nitric acid.")
        Else
    ...
    Private Sub place07_4_Click(sender As Object, e As EventArgs) Handles place07_4.Click
        If picturebox2.Tag >= 24 Then
            If picturebox2.Tag = 24 Then
                MsgBox("Strangely, the worm water disappeared at all. Is it the rooster carried away the liquid? That's so strange!", 0, "Strange situation")
            End If
    ...
    Private Sub place08_2_Click(sender As Object, e As EventArgs) Handles place08_2.Click
        ...
        Else
            Form11.start(27, "Waste liquid cylinder", "There's NaCl, I, CCl4 solution in it, looked colorful, but we cannot drink it.", "Yes.")
        End If
    End Sub
        ...
        If CostPower(6) Then
            If items.Items.Contains("Chemistry cabinet key") Then
                If picturebox2.Tag = 15 Then
                    ...
                    If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound48.wm")
                ...
                If picturebox2.Tag = 15 Then
                    picturebox2.Tag = 16
                    MsgBox("Let's buy something inside... Though we have no money, but it seems something's price is zero.")
                End If
            Else
    ...
    Private Sub place10_6_Click(sender As Object, e As EventArgs) Handles place10_6.Click
        If OnFire Then
            MsgBox("The ground shows that you should go to the top floor with a plastic hammer, then go out, then go inside again, then go out again. After doing all of these, enter ""I want a hard hammer"".")
        Else
            ...
            If items.Items.Contains("Amber key") Then
                If MsgBox("Do you want to open the door of Amber Nest by using the key?", vbYesNo, "Amber Nest") = vbYes Then
    ...
    Private Sub place10_7_Click(sender As Object, e As EventArgs) Handles place10_7.Click
        If OnFire Then
            If place10_7.Tag = 3 Then
                ...
                Exit Sub
            End If
            MsgBox("There is a big huge monster statue blocked the way. It's the witch, once again. Of course.", 0, "Trick!")
            ...
            If items.Items.Contains("hammer") Then
                If MsgBox("You can use hammer to break the statue.", vbYesNo, "Break") = vbYes Then
                    If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound12.wm")
                    MsgBox("The hammer is too small, the statue is too big. The hammer is too small, the statue is too big." & vbCrLf & "So that" & vbCrLf & "It's improbable to break.", 0, "No use")
                End If
            ...
            If items.Items.Contains("hammer") Then
                If MsgBox("Probably you can use hammer to break.", vbYesNo, "Break") = vbYes Then
                    ...
                    If MsgBox("It's better to use hand to break.", vbYesNo, "Break") = vbYes Then
                        If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound3.wm")
    ...
    Private Sub place11_1_Click(sender As Object, e As EventArgs) Handles place11_1.Click
        If CostPower(1) Then
            ...
            If picturebox2.Tag = 27 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound36.wm")
                MsgBox("Suddenly, the witch's sound spreads out from Amber Nest!", 0, "Witch!")
                MsgBox("The turkey has run away from that room to the right side. We must open that door and find the fact.", 0, "Mystery")
    ...
    Private Sub place05_4_Click(sender As Object, e As EventArgs) Handles place05_4.Click
        If picturebox2.Tag = 29 Then
            picturebox2.Tag = 30
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound41.wm")
    ...
    Private Sub place12_3_Click(sender As Object, e As EventArgs) Handles place12_3.Click
        ...
        Else
            If picturebox2.Tag = 35 Then
                picturebox2.Tag = 36
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound45.wm")
    ...
    Public Sub SaveGame(chapter As String, place As String, appendix As Integer, potionshop As Boolean)
        ...
        My.Settings.magics = ""
        For i As Integer = 0 To magics.Items.Count - 1
        ...
        If potionshop Then
            For i As Integer = 0 To Form13.ItemsList.Items.Count - 1
        ...
        For i As Integer = 0 To Unlocked.Items.Count - 1
    ...
    Private Sub place13_3_Click(sender As Object, e As EventArgs) Handles place13_3.Click
        If OnFire Then
            If place13_3.Tag = 1 Then
                MsgBox("There is a key to biology lab cabinet inside the machine, but it is stucked in a crack, the crack is too small that you cannot take it out.", 0, "Key")
                ...
                End If
            Else
                Form11.start(32, "Function upgrader", "You can still upgrade the Duck function. But under the fire, you need not at present.", "Back and escape.")
            End If
        Else
            If magics.Items.Contains("Duck function+") Then
                Form11.start(32, "Function upgrader", "You can still upgrade the Duck function! By using this machine.", "Back.", "Full Upgrade")
            Else
                Form11.start(29, "Function upgrader", "There is a function upgrader machine in toilet, you can put duck function inside and upgrade it.", "Back.", "Upgrade")
            End If
        End If
    End Sub
    ...
    Private Sub place14_3_Click(sender As Object, e As EventArgs) Handles place14_3.Click
        If picturebox2.Tag = 33 Then
            picturebox2.Tag = 34
            MsgBox("It is a questioning machine! You must correctly answer a easy question then you can get things inside.", 0, "Questioning machine.")
            Hide()
            Form14.Show()
            Form14.ClearAll()
    ...
    Private Sub place16_2_Click(sender As Object, e As EventArgs) Handles place16_2.Click
        ...
        If Form14.TextBox2.ForeColor = Color.Green And Form14.TextBox3.ForeColor = Color.Green And Form14.TextBox4.ForeColor = Color.Green Then
    ...
    Private Sub place17_1_Click(sender As Object, e As EventArgs) Handles place17_1.Click
        If picturebox2.Tag = 40 Then
            MsgBox("The door is locked, the lock is new. Of course it is the witch burned the room and locked the door.", 0, "Lock")
    ...
    Private Sub place17_2_Click(sender As Object, e As EventArgs) Handles place17_2.Click
        ...
        If items.Items.Contains("Mr.Duck's plank") Then
            ...
            If place17_2.Tag = 3 Then
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound17.wm")
    ...
    Private Sub place18_2_Click(sender As Object, e As EventArgs) Handles place18_2.Click
        If items.Items.Contains("Witch clothes") Then
            MsgBox("There is nothing", 0, "Nothing")
        Else
            If MsgBox("Oh there is full of witch's clothes, do you want to get one?", vbYesNo, "Witch clothes") = vbYes Then
    ...
    Private Sub place19_3_Click(sender As Object, e As EventArgs) Handles place19_3.Click
        If picturebox2.Tag = 39 Then
            picturebox2.Tag = 40
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound34.wm")
            Hide()
            music.Ctlcontrols.stop()
            ChangeMusic.Enabled = False
            MsgBox("!!!!!!!!!!!!!!!", 0, "!!")
            Form11.start(33, "Stunned!", "Suddenly, you don't know the source.. but you.. have been stunned!", "Wake up!")
        Else
            If CostPower(4) Then
                Scene23Appears()
            End If
    ...
    Private Sub fire_Tick(sender As Object, e As EventArgs) Handles fire.Tick
        ...
        If p1.BackColor = Color.FromArgb(0, 0, 0) And (place22_2.Tag < 3 Or place21_2.Tag = 1) Then GameOver("One of the rooms has gotten collapsed and blocked your way.")
        If p2.BackColor = Color.FromArgb(0, 0, 0) And place22_2.Tag < 3 Then GameOver("One of the rooms has gotten collapsed and blocked your way.")
        If p3.BackColor = Color.FromArgb(0, 0, 0) And place21_2.Tag = 1 Then GameOver("One of the rooms has gotten collapsed and blocked your way.")
        If (p8.BackColor = Color.FromArgb(0, 0, 0) Or p9.BackColor = Color.FromArgb(0, 0, 0)) And items.Items.Contains("Witch clothes") = False Then GameOver("One of the rooms has gotten collapsed and blocked your way.")
        If CurrentPlace.Text = "mysterious" And p8.BackColor = Color.FromArgb(0, 0, 0) Then GameOver("One of the rooms has gotten collapsed and blocked your way.")
        If p5.BackColor = Color.FromArgb(0, 0, 0) And place13_3.Tag < 2 Then GameOver("One of the rooms has gotten collapsed and blocked your way.")
        If p4.BackColor = Color.FromArgb(0, 0, 0) And (CurrentPlace.Text = "mysterious" Or items.Items.Contains("Witch clothes") = False Or place13_3.Tag < 2) Then GameOver("One of the rooms has gotten collapsed and blocked your way.")
        If p12.BackColor = Color.FromArgb(0, 0, 0) And Not CurrentPlace.Text = "odd playground" Then GameOver("One of the rooms has gotten collapsed and blocked your way.")
        If p17.BackColor = Color.FromArgb(0, 0, 0) And place09_2.Tag < 2 Then GameOver("One of the rooms has gotten collapsed and blocked your way.")
        If p18.BackColor = Color.FromArgb(0, 0, 0) And items.Items.Contains("Sodium") = False Then GameOver("One of the rooms has gotten collapsed and blocked your way.")
    End Sub
    Private Sub SpreadFire(ByVal target As Label, spreaders As Label())
        If target.BackColor = Color.FromArgb(0, 0, 0) Then Exit Sub
        Dim random_ As Random = New Random(Now.Date.Millisecond)
        Dim AddFire As Double = 0
        For Each spreader In spreaders
            If spreader.Tag.ToString.Split("/").Count = 1 Then Continue For
            If spreader.BackColor = Color.FromArgb(0, 0, 0) Or spreader.BackColor = Color.FromArgb(255, 255, 255) Then Continue For
            If target.Tag.ToString.Split("/").Count = 2 Then AddFire += Math.Max(0, Math.Min(CDbl(spreader.Tag.ToString.Split("/")(0)), CDbl(spreader.Tag.ToString.Split("/")(1)))) / 20
        Next
        For Each spreader In spreaders
            If spreader.Tag.ToString.Split("/").Count = 1 Then Continue For
            If spreader.BackColor = Color.FromArgb(0, 0, 0) Or spreader.BackColor = Color.FromArgb(255, 255, 255) Then Continue For
            If target.Tag.ToString.Split("/").Count = 1 Then
                If Math.Log(Math.Min(CDbl(spreader.Tag.ToString.Split("/")(0)), CDbl(spreader.Tag.ToString.Split("/")(1))) / spreader.Tag.ToString.Split("/")(1) + 1, 10) > Rnd() Then
                    target.Tag = "0/" & target.Tag
                    If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound10.wm")
                    target.BackColor = Color.FromArgb(255, Math.Min(255, Math.Max(0, 255 * (1 - target.Tag.ToString.Split("/")(0) / target.Tag.ToString.Split("/")(1)))), Math.Min(255, Math.Max(0, 255 * (1 - target.Tag.ToString.Split("/")(0) / target.Tag.ToString.Split("/")(1)))))
                End If
            End If
        Next
        If AddFire > 0 Then
            ...
            If Math.Log(target.Tag.ToString.Split("/")(0) / target.Tag.ToString.Split("/")(1) - 1, 10) > Rnd() Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound32.wm")
    ...
    Private Sub firecost_Tick(sender As Object, e As EventArgs) Handles firecost.Tick
        firecost.Tag += 10
        If CurrentPlace.Tag.ToString.Split("/").Count > 1 AndAlso firecost.Tag >= Math.Pow(40 * (1.25 - Math.Min(CDbl(CurrentPlace.Tag.ToString.Split("/")(0)), CDbl(CurrentPlace.Tag.ToString.Split("/")(1))) / CurrentPlace.Tag.ToString.Split("/")(1)), 1.5) Then
            firecost.Tag = 0
            life.Value -= 1
    ...
    Private Sub place21_4_Click(sender As Object, e As EventArgs) Handles place21_4.Click
        If MsgBox("Do you want to play the piano?", vbYesNo, "Confirm") = vbYes Then
            ...
            Disappear1()
            picturebox2.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image1.wm")
...
wrong:
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        ...
        If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound13.wm")
        If p1.Tag.ToString.Split("/").Count = 2 Then p1.Tag = Math.Min(CDbl(p1.Tag.ToString.Split("/")(0)), CDbl(p1.Tag.ToString.Split("/")(1))) / 2 & "/" & p1.Tag.ToString.Split("/")(1)
        If p2.Tag.ToString.Split("/").Count = 2 Then p2.Tag = Math.Min(CDbl(p2.Tag.ToString.Split("/")(0)), CDbl(p2.Tag.ToString.Split("/")(1))) / 2 & "/" & p2.Tag.ToString.Split("/")(1)
        If p3.Tag.ToString.Split("/").Count = 2 Then p3.Tag = Math.Min(CDbl(p3.Tag.ToString.Split("/")(0)), CDbl(p3.Tag.ToString.Split("/")(1))) / 2 & "/" & p3.Tag.ToString.Split("/")(1)
        If p4.Tag.ToString.Split("/").Count = 2 Then p4.Tag = Math.Min(CDbl(p4.Tag.ToString.Split("/")(0)), CDbl(p4.Tag.ToString.Split("/")(1))) / 2 & "/" & p4.Tag.ToString.Split("/")(1)
        If p5.Tag.ToString.Split("/").Count = 2 Then p5.Tag = Math.Min(CDbl(p5.Tag.ToString.Split("/")(0)), CDbl(p5.Tag.ToString.Split("/")(1))) / 2 & "/" & p5.Tag.ToString.Split("/")(1)
        If p6.Tag.ToString.Split("/").Count = 2 Then p6.Tag = Math.Min(CDbl(p6.Tag.ToString.Split("/")(0)), CDbl(p6.Tag.ToString.Split("/")(1))) / 2 & "/" & p6.Tag.ToString.Split("/")(1)
        If p7.Tag.ToString.Split("/").Count = 2 Then p7.Tag = Math.Max(25, Math.Min(CDbl(p7.Tag.ToString.Split("/")(0)), CDbl(p7.Tag.ToString.Split("/")(1))) / 2) & "/" & p7.Tag.ToString.Split("/")(1)
        If p8.Tag.ToString.Split("/").Count = 2 Then p8.Tag = Math.Min(CDbl(p8.Tag.ToString.Split("/")(0)), CDbl(p8.Tag.ToString.Split("/")(1))) / 2 & "/" & p8.Tag.ToString.Split("/")(1)
        If p9.Tag.ToString.Split("/").Count = 2 Then p9.Tag = Math.Min(CDbl(p9.Tag.ToString.Split("/")(0)), CDbl(p9.Tag.ToString.Split("/")(1))) / 2 & "/" & p9.Tag.ToString.Split("/")(1)
        If p10.Tag.ToString.Split("/").Count = 2 Then p10.Tag = Math.Min(CDbl(p10.Tag.ToString.Split("/")(0)), CDbl(p10.Tag.ToString.Split("/")(1))) / 2 & "/" & p10.Tag.ToString.Split("/")(1)
        If p11.Tag.ToString.Split("/").Count = 2 Then p11.Tag = Math.Min(CDbl(p11.Tag.ToString.Split("/")(0)), CDbl(p11.Tag.ToString.Split("/")(1))) / 2 & "/" & p11.Tag.ToString.Split("/")(1)
        If p12.Tag.ToString.Split("/").Count = 2 Then p12.Tag = Math.Min(CDbl(p12.Tag.ToString.Split("/")(0)), CDbl(p12.Tag.ToString.Split("/")(1))) / 2 & "/" & p12.Tag.ToString.Split("/")(1)
        If p13.Tag.ToString.Split("/").Count = 2 Then p13.Tag = Math.Min(CDbl(p13.Tag.ToString.Split("/")(0)), CDbl(p13.Tag.ToString.Split("/")(1))) / 2 & "/" & p13.Tag.ToString.Split("/")(1)
        If p14.Tag.ToString.Split("/").Count = 2 Then p14.Tag = Math.Min(CDbl(p14.Tag.ToString.Split("/")(0)), CDbl(p14.Tag.ToString.Split("/")(1))) / 2 & "/" & p14.Tag.ToString.Split("/")(1)
        If p15.Tag.ToString.Split("/").Count = 2 Then p15.Tag = Math.Min(CDbl(p15.Tag.ToString.Split("/")(0)), CDbl(p15.Tag.ToString.Split("/")(1))) / 2 & "/" & p15.Tag.ToString.Split("/")(1)
        If p16.Tag.ToString.Split("/").Count = 2 Then p16.Tag = Math.Min(CDbl(p16.Tag.ToString.Split("/")(0)), CDbl(p16.Tag.ToString.Split("/")(1))) / 2 & "/" & p16.Tag.ToString.Split("/")(1)
        If p17.Tag.ToString.Split("/").Count = 2 Then p17.Tag = Math.Min(CDbl(p17.Tag.ToString.Split("/")(0)), CDbl(p17.Tag.ToString.Split("/")(1))) / 2 & "/" & p17.Tag.ToString.Split("/")(1)
        If p18.Tag.ToString.Split("/").Count = 2 Then p18.Tag = Math.Min(CDbl(p18.Tag.ToString.Split("/")(0)), CDbl(p18.Tag.ToString.Split("/")(1))) / 2 & "/" & p18.Tag.ToString.Split("/")(1)
        If p19.Tag.ToString.Split("/").Count = 2 Then p19.Tag = Math.Min(CDbl(p19.Tag.ToString.Split("/")(0)), CDbl(p19.Tag.ToString.Split("/")(1))) / 2 & "/" & p19.Tag.ToString.Split("/")(1)
        If p20.Tag.ToString.Split("/").Count = 2 Then p20.Tag = Math.Min(CDbl(p20.Tag.ToString.Split("/")(0)), CDbl(p20.Tag.ToString.Split("/")(1))) / 2 & "/" & p20.Tag.ToString.Split("/")(1)
        If p21.Tag.ToString.Split("/").Count = 2 Then p21.Tag = Math.Min(CDbl(p21.Tag.ToString.Split("/")(0)), CDbl(p21.Tag.ToString.Split("/")(1))) / 2 & "/" & p21.Tag.ToString.Split("/")(1)
        If p22.Tag.ToString.Split("/").Count = 2 Then p22.Tag = Math.Min(CDbl(p22.Tag.ToString.Split("/")(0)), CDbl(p22.Tag.ToString.Split("/")(1))) / 2 & "/" & p22.Tag.ToString.Split("/")(1)
        If p23.Tag.ToString.Split("/").Count = 2 Then p23.Tag = Math.Min(CDbl(p23.Tag.ToString.Split("/")(0)), CDbl(p23.Tag.ToString.Split("/")(1))) / 2 & "/" & p23.Tag.ToString.Split("/")(1)
    End Sub
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        heal -= 1
        Button6.Text = "Heal(" & heal & ")+30%"
        If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound15.wm")
        If heal = 0 Then
            Button6.Enabled = False
        Else
            Button6.Enabled = True
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        revive -= 1
        Button7.Text = "Revive(" & heal & ")+100%"
        If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound19.wm")
        If heal = 0 Then
            Button7.Enabled = False
        Else
            Button7.Enabled = True
    ...
    Private Sub place23_2_Click(sender As Object, e As EventArgs) Handles place23_2.Click
        MsgBox("The hand basins are all extremely dirty: filled with worms, dirts, and something like shits.", 0, "Dirty")
    End Sub
    Private Sub place23_4_Click(sender As Object, e As EventArgs) Handles place23_4.Click
        MsgBox("The urinals are all extremely smelly: filled with green smelly waters, and something like worms.", 0, "Smelly")
    End Sub
    Private Sub place23_3_Click(sender As Object, e As EventArgs) Handles place23_3.Click
        MsgBox("The doors of stool pools are all broken and can only be opened a little, except worms, human cannot be so thin like that.", 0, "Shrunk")
    ...
    End Sub
    Private Sub PutThing(ByVal thing As Control)
        thing.Parent = PictureBox3
        If Not Unlocked.Items.Contains(thing.Name) Then thing.Visible = True
    End Sub
    Friend Sub Scene001appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene35.wm")
        PutThing(lock26_1)
        PutThing(backward)
        PutThing(arrow34_2)
        PutThing(place26_4)
    ...
    Friend Sub Scene002appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene36.wm")
        PutThing(lock27_1)
        PutThing(lock27_2)
        PutThing(place26_4)
        PutThing(arrow32_2)
    ...
    Friend Sub Scene003appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene37.wm")
        PutThing(place28_2)
        PutThing(place28_3)
        PutThing(box28_1)
        PutThing(backward)
    ...
    Friend Sub Scene004appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene38.wm")
        PutThing(place26_4)
        PutThing(arrow32_2)
        PutThing(lock29_1)
        PutThing(backward)
    ...
    Friend Sub Scene005appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene39.wm")
        PutThing(place30_2)
    ...
    Friend Sub Scene006appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene40.wm")
        PutThing(key31_1)
        PutThing(lock31_2)
        PutThing(potion31_3)
        PutThing(arrow32_2)
    ...
    Friend Sub Scene007appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene41.wm")
        backward.Tag = 32
        PutThing(backward)
        PutThing(arrow32_2)
    End Sub
    Friend Sub Scene008appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene42.wm")
        backward.Tag = 33
        PutThing(arrow33_1)
        PutThing(backward)
        PutThing(arrow33_3)
    ...
    Friend Sub Scene009appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene43.wm")
        backward.Tag = 34
        PutThing(backward)
        PutThing(arrow34_2)
        PutThing(arrow34_3)
    ...
    Friend Sub Scene010appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene44.wm")
        backward.Tag = 35
        PutThing(backward)
        PutThing(water35_2)
    ...
    Friend Sub Scene011appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene45.wm")
        PutThing(arrow32_2)
    End Sub
    Friend Sub Scene012appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene46.wm")
        backward.Tag = 37
        PutThing(backward)
        PutThing(arrow37_2)
    ...
    Friend Sub Scene013appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene47.wm")
        backward.Tag = 38
        PutThing(backward)
        PutThing(dive38_1)
        PutThing(arrow34_3)
    ...
    Friend Sub Scene014appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene48.wm")
        backward.Tag = 39
        PutThing(backward)
        PutThing(arrow32_2)
        PutThing(paper39_1)
    ...
    Friend Sub Scene015appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene49.wm")
        backward.Tag = 40
        PutThing(backward)
        PutThing(arrow40_1)
        PutThing(lock40_2)
    ...
    Friend Sub Scene016appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene50.wm")
        backward.Tag = 41
        PutThing(backward)
        PutThing(arrow41_1)
        PutThing(lock41_2)
    ...
    Friend Sub Scene017appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene51.wm")
        backward.Tag = 42
        PutThing(backward)
        PutThing(arrow41_1)
        PutThing(place42_1)
    ...
    Friend Sub Scene018appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene52.wm")
        backward.Tag = 43
        PutThing(backward)
        PutThing(place43_1)
        PutThing(arrow34_2)
    ...
    Friend Sub Scene019appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene53.wm")
        backward.Tag = 44
        PutThing(place44_1)
        PutThing(place44_2)
        PutThing(paper44_3)
    ...
    Friend Sub Scene020appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene54.wm")
        backward.Tag = 45
        PutThing(backward)
        PutThing(arrow45_1)
        PutThing(blood45_2)
    ...
    Friend Sub Scene021appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene55.wm")
        backward.Tag = 46
        PutThing(backward)
        PutThing(arrow46_1)
        PutThing(lock46_2)
    ...
    Friend Sub Scene022appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene56.wm")
        backward.Tag = 47
        PutThing(backward)
        PutThing(potion47_1)
        PutThing(potion47_2)
    ...
    Friend Sub Scene023appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene57.wm")
        backward.Tag = 48
        PutThing(backward)
    ...
    Friend Sub Scene024appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene58.wm")
        backward.Tag = 49
        PutThing(arrow32_2)
    End Sub
    Friend Sub Scene025appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene59.wm")
        backward.Tag = 50
        PutThing(backward)
        PutThing(arrow50_1)
    ...
    Friend Sub Scene026appears()
        ...
        If PictureBox3.Tag < 11 Then
            PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene60.wm")
        Else
            PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene60_2.wm")
        End If
        backward.Tag = 51
        PutThing(backward)
        PutThing(arrow50_1)
    ...
    Friend Sub Scene027appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene61.wm")
        backward.Tag = 52
        PutThing(backward)
        PutThing(arrow50_1)
    End Sub
    Friend Sub Scene028appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene62.wm")
        backward.Tag = 53
        PutThing(backward)
        PutThing(arrow41_3)
    End Sub
    Friend Sub Scene029appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene63.wm")
        backward.Tag = 54
        PutThing(backward)
        PutThing(place30_2)
        PutThing(arrow54_1)
    ...
    Friend Sub Scene030appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene64.wm")
        backward.Tag = 55
        PutThing(backward)
        PutThing(arrow55_1)
    End Sub
    Friend Sub Scene031appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene65.wm")
        backward.Tag = 56
        PutThing(backward)
        PutThing(arrow33_3)
    End Sub
    Friend Sub Scene032appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene66.wm")
        backward.Tag = 57
        PutThing(backward)
        PutThing(arrow57_1)
        PutThing(lock57_2)
    ...
    Friend Sub Scene033appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene67.wm")
        backward.Tag = 58
        PutThing(backward)
        PutThing(arrow50_1)
        PutThing(bottle58_1)
    ...
    Friend Sub Scene034appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene68.wm")
        backward.Tag = 59
        PutThing(backward)
        PutThing(water35_2)
    End Sub
    Friend Sub Scene035appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene69.wm")
        backward.Tag = 60
        PutThing(backward)
        PutThing(arrow32_2)
    End Sub
    Friend Sub Scene036appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene70.wm")
        backward.Tag = 61
        PutThing(backward)
        PutThing(arrow32_2)
    End Sub
    Friend Sub Scene037appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene71.wm")
        backward.Tag = 62
        PutThing(backward)
        PutThing(place30_2)
        PutThing(arrow62_1)
    ...
    Friend Sub Scene038appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene72.wm")
        backward.Tag = 63
        PutThing(backward)
        PutThing(arrow63_1)
        PutThing(laptop63_2)
    ...
    Friend Sub Scene039appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene73.wm")
        backward.Tag = 64
        PutThing(backward)
        PutThing(dive64_1)
    End Sub
    Friend Sub Scene040appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene74.wm")
        backward.Tag = 65
        PutThing(backward)
        PutThing(arrow50_1)
    ...
    Friend Sub Scene041appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene75.wm")
        backward.Tag = 66
        PutThing(backward)
        PutThing(arrow66_1)
        PutThing(lock66_2)
    ...
    Friend Sub Scene042appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene76.wm")
        backward.Tag = 67
        PutThing(backward)
        PutThing(paper46_4)
        PutThing(mp67_1)
    ...
    Friend Sub Scene043appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene77.wm")
        backward.Tag = 68
        PutThing(backward)
        PutThing(arrow68_1)
        PutThing(lock68_2)
    ...
    Friend Sub Scene044appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene78.wm")
        backward.Tag = 69
        PutThing(backward)
        PutThing(arrow69_1)
        PutThing(lock69_2)
    ...
    Friend Sub Scene045appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene79.wm")
        backward.Tag = 70
        PutThing(backward)
        PutThing(arrow70_1)
        PutThing(lock70_2)
    ...
    Friend Sub Scene046appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene80.wm")
        backward.Tag = 71
        PutThing(backward)
    ...
    Friend Sub Scene047appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene81.wm")
        backward.Tag = 72
        PutThing(backward)
        PutThing(arrow50_1)
        PutThing(lock72_1)
    ...
    Friend Sub Scene048appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene82.wm")
        backward.Tag = 73
        PutThing(backward)
        PutThing(answer73_3)
        PutThing(arrow73_1)
    ...
    Friend Sub Scene049appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene83.wm")
        backward.Tag = 74
        PutThing(backward)
        PutThing(arrow50_1)
        PutThing(chest74_1)
    ...
    Friend Sub Scene050appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene84.wm")
        backward.Tag = 75
        PutThing(arrow33_1)
        PutThing(place26_4)
    End Sub
    Friend Sub Scene051appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene85.wm")
        backward.Tag = 76
        PutThing(backward)
        PutThing(arrow41_3)
    End Sub
    Friend Sub Scene052appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene86.wm")
        backward.Tag = 77
        PutThing(backward)
        PutThing(arrow32_2)
    End Sub
    Friend Sub Scene053appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene87.wm")
        backward.Tag = 78
        PutThing(backward)
        PutThing(arrow32_2)
    End Sub
    Friend Sub Scene054appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene88.wm")
        backward.Tag = 79
        PutThing(backward)
        PutThing(arrow79_1)
    End Sub
    Friend Sub Scene055appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene89.wm")
        backward.Tag = 80
        PutThing(backward)
        PutThing(arrow55_1)
    End Sub
    Friend Sub Scene056appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene90.wm")
        backward.Tag = 81
    ...
    Friend Sub Scene057appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene91.wm")
        backward.Tag = 82
        PutThing(arrow82_1)
        PutThing(letter82_2)
        PutThing(chest82_3)
    ...
    Friend Sub Scene058appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene92.wm")
        backward.Tag = 83
        PutThing(arrow92_1)
        PutThing(bow92_2)
        PutThing(arrow92_3)
    ...
    Friend Sub Scene059appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene93.wm")
        backward.Tag = 84
        PutThing(backward)
    ...
    Friend Sub Scene060appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene94.wm")
        backward.Tag = 85
        PutThing(backward)
        PutThing(box85_1)
    End Sub
    Friend Sub Scene061appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene95.wm")
        backward.Tag = 86
        PutThing(backward)
    ...
    Friend Sub Scene062appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene96.wm")
        backward.Tag = 87
        PutThing(backward)
        PutThing(gas87_1)
        PutThing(paper87_2)
    ...
    Friend Sub Scene063appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene97.wm")
        backward.Tag = 88
        PutThing(arrow41_3)
        PutThing(backward)
    End Sub
    Friend Sub Scene064appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene98.wm")
        backward.Tag = 89
        PutThing(backward)
        PutThing(arrow32_2)
    End Sub
    Friend Sub Scene065appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene99.wm")
        backward.Tag = 90
        PutThing(backward)
        PutThing(arrow46_1)
        PutThing(place30_2)
    ...
    Friend Sub Scene066appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene100.wm")
        backward.Tag = 91
        PutThing(backward)
        PutThing(arrow32_2)
        PutThing(lock91_1)
    ...
    Friend Sub Scene067appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene101.wm")
        backward.Tag = 92
        PutThing(backward)
        PutThing(arrow70_1)
    ...
    Friend Sub Scene068appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene102.wm")
        backward.Tag = 93
        PutThing(backward)
        PutThing(arrow50_1)
        PutThing(gas93_1)
    ...
    Friend Sub Scene069appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene103.wm")
        backward.Tag = 94
        PutThing(backward)
        PutThing(arrow62_1)
        PutThing(potion94_2)
    ...
    Friend Sub Scene070appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene104.wm")
        backward.Tag = 95
        PutThing(backward)
        PutThing(teleporter95_1)
        teleporter95_1.Size = New Size(192, 192)
        If Unlocked.Items.Contains("mirror1deflect") Then teleporter95_1.Image = ImageList1.Images(73) Else teleporter95_1.Image = ImageList1.Images(74)
    End Sub
    Friend Sub Scene071appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene105.wm")
        backward.Tag = 96
        PutThing(backward)
        PutThing(arrow69_1)
        PutThing(card96_1)
    ...
    Friend Sub Scene072appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene106.wm")
        backward.Tag = 97
        PutThing(backward)
        PutThing(arrow41_3)
        PutThing(arrow81_3)
        PutThing(teleporter95_1)
        teleporter95_1.Size = New Size(192, 192)
        If Unlocked.Items.Contains("mirror2deflect") Then teleporter95_1.Image = ImageList1.Images(73) Else teleporter95_1.Image = ImageList1.Images(74)
    End Sub
    Friend Sub Scene073appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene107.wm")
        backward.Tag = 98
        PutThing(box98_1)
        PutThing(paper98_2)
    ...
    Friend Sub Scene074appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene108.wm")
        backward.Tag = 99
        PutThing(backward)
        PutThing(arrow99_1)
        PutThing(arrow57_1)
    ...
    Friend Sub Scene075appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene109.wm")
        backward.Tag = 100
        PutThing(backward)
        PutThing(box100_1)
    ...
    Friend Sub Scene076appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene110.wm")
        backward.Tag = 101
        PutThing(backward)
        PutThing(gem101_1)
        PutThing(arrow101_2)
    ...
    Friend Sub Scene077appears()
        Disappear2()
        If Unlocked.Items.Contains("build stairs") Then PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene111_1.wm") Else PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene111.wm")
        backward.Tag = 102
        PutThing(backward)
        PutThing(arrow50_1)
    ...
    Friend Sub Scene078appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene112.wm")
        backward.Tag = 103
        PutThing(backward)
        PutThing(arrow103_1)
    End Sub
    Friend Sub Scene079appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene113.wm")
        backward.Tag = 104
        PutThing(backward)
        PutThing(arrow33_3)
    End Sub
    Friend Sub Scene080appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene114.wm")
        backward.Tag = 105
        PutThing(backward)
        PutThing(arrow105_1)
    ...
    Friend Sub Scene081appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene115.wm")
        backward.Tag = 106
        PutThing(backward)
    ...
    Friend Sub Scene082appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene116.wm")
        backward.Tag = 107
        PutThing(backward)
    ...
    Friend Sub Scene083appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene117.wm")
        backward.Tag = 108
        PutThing(backward)
        PutThing(arrow33_1)
    End Sub
    Friend Sub Scene084appears()
        Disappear2()
        PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\scene118.wm")
        backward.Tag = 109
    End Sub
    Private Sub MoveAtropos_Tick(sender As Object, e As EventArgs) Handles MoveAtropos.Tick
        If MoveHydrogenPeroxide Then
            ...
            If blocker68_3.Top < -33 + 6 And blocker68_3.Top > -33 - 6 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound55.wm")
        ...
        If actor.Top = 0 Then
            If PictureBox3.Tag = 5 Then
                MoveAtropos.Enabled = False
                SendMessage("Prince frog:" & vbCrLf & "Hello, I'm prince frog, you can straight call me Mr.Frog.", 0, "What's up?")
                Exit Sub
            ...
            If MoveAtropos.Tag = 20 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue1.wm")
            ElseIf MoveAtropos.Tag = 190 Then
                dialogue.ForeColor = Color.Black
                dialogue.Text = "This is his destiny, no one can change it." & vbCrLf & "He sacrificed himself to the witch, so he must die."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue2.wm")
            ElseIf MoveAtropos.Tag = 440 Then
                dialogue.Text = "You have no right to pass through the time" & vbCrLf & "and change the past."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue3.wm")
            ElseIf MoveAtropos.Tag = 570 Then
                dialogue.Text = "You soon will find your efforts useless," & vbCrLf & "and things you did are a great failure."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue4.wm")
            ElseIf MoveAtropos.Tag = 800 Then
                dialogue.Text = "I'll not let you succeed. Of course."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue5.wm")
            ...
            ElseIf MoveAtropos.Tag = 901 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue6.wm")
            ElseIf MoveAtropos.Tag = 1050 Then
                dialogue.Text = "As for these mortals, at beginning, their surfaces make" & vbCrLf & "illusions to others and themselves."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue7.wm")
            ElseIf MoveAtropos.Tag = 1225 Then
                dialogue.Text = "Then they start to abandon each other." & vbCrLf & "But they'll never know what'll happen after their abandon."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue8.wm")
            ElseIf MoveAtropos.Tag = 1370 Then
                dialogue.Text = "And after all of these, they cycle again and again."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue9.wm")
            ElseIf MoveAtropos.Tag = 1475 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue10.wm")
            ...
            ElseIf MoveAtropos.Tag = 1780 Then
                Hide()
                Form7.Show()
                Form7.initialization(shield_level, weapon_level, 0, 300 + shield_level * 150, 2000, 14, 400, 100, 500, 1000)
                music.settings.setMode("loop", True)
                music.settings.volume = 100
            ...
            ElseIf MoveAtropos.Tag = 1800 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\voice18.wm")
            ...
            ElseIf MoveAtropos.Tag = 1901 Then
                ...
                backward.Left = (PictureBox3.Width - backward.Width) / 2
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\voice19.wm")
            ...
            ElseIf MoveAtropos.Tag = 2001 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\voice20.wm")
            ...
            ElseIf MoveAtropos.Tag = 2101 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\voice21.wm")
            ...
            ElseIf MoveAtropos.Tag = 2201 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\voice22.wm")
            ...
            ElseIf MoveAtropos.Tag = 2301 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue11.wm")
            ElseIf MoveAtropos.Tag = 2455 Then
                dialogue.Text = "The next station is the hell. Come on, my ghost."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue12.wm")
            ElseIf MoveAtropos.Tag = 2575 Then
                dialogue.Text = "*ghost*"
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\battler15.wm")
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue13.wm")
            ...
            ElseIf MoveAtropos.Tag = 2750 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue14.wm")
            ElseIf MoveAtropos.Tag = 2800 Then
                actor.Image = Nothing
                dialogue.Text = "You will dive into the hell and find the source of" & vbCrLf & "their tragedies."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue15.wm")
            ElseIf MoveAtropos.Tag = 2925 Then
                dialogue.Text = "It's the time for you to feel their miseries." & vbCrLf & "Good luck, mortal."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue16.wm")
            ...
            ElseIf MoveAtropos.Tag = 3051 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue17.wm")
            ...
            ElseIf MoveAtropos.Tag = 3126 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue18.wm")
            ...
            ElseIf MoveAtropos.Tag = 3201 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue19.wm")
            ...
            ElseIf MoveAtropos.Tag = 3276 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue20.wm")
            ...
            ElseIf MoveAtropos.Tag = 3351 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue21.wm")
            ...
            ElseIf MoveAtropos.Tag = 3410 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue22.wm")
            ElseIf MoveAtropos.Tag = 3550 Then
                dialogue.Text = "If they awaken now, the doom will not happen."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue23.wm")
            ElseIf MoveAtropos.Tag = 3640 Then
                dialogue.Text = "But it's impossible."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue24.wm")
            ...
            ElseIf MoveAtropos.Tag = 3711 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue25.wm")
            ElseIf MoveAtropos.Tag = 3800 Then
                dialogue.Text = "*scream*"
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image11.wm")
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue26.wm")
            ElseIf MoveAtropos.Tag = 3825 Then
                dialogue.Text = "I will defeat you, you vicious witch!"
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue27.wm")
            ElseIf MoveAtropos.Tag = 3875 Then
                dialogue.Text = "Atropos! Give me power!!"
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue28.wm")
            ElseIf MoveAtropos.Tag = 3950 Then
                dialogue.ForeColor = Color.Red
                dialogue.Text = "Yes. Destroy the stupid guy, she had broken my" & vbCrLf & "control."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue29.wm")
            ElseIf MoveAtropos.Tag = 4100 Then
                dialogue.Text = "Here is your power."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue30.wm")
            ElseIf MoveAtropos.Tag = 4150 Then
                dialogue.Text = ""
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image12.wm")
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound10.wm")
            ElseIf MoveAtropos.Tag = 4175 Then
                dialogue.ForeColor = Color.White
                dialogue.Text = "Oh no! I hit the fire!!"
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image13.wm")
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue31.wm")
            ElseIf MoveAtropos.Tag = 4225 Then
                dialogue.ForeColor = Color.Red
                dialogue.Text = "Tarecgosa, you abused the mortals' lust, and became their" & vbCrLf & "goddess by this way. Now you'll get your DOOM!!"
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue32.wm")
            ElseIf MoveAtropos.Tag = 4475 Then
                dialogue.Text = "Annihilate!!"
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue33.wm")
            ElseIf MoveAtropos.Tag = 4550 Then
                dialogue.Text = ""
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image14.wm")
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound32.wm")
            ElseIf MoveAtropos.Tag = 4600 Then
                dialogue.ForeColor = Color.White
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image15.wm")
                dialogue.Text = "Mortal, though that guy hurt me, but I can still defeat you." & vbCrLf & "Let's battle, and you will belong to me."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue34.wm")
            ElseIf MoveAtropos.Tag = 4900 Then
                dialogue.ForeColor = Color.White
                dialogue.Text = "Let's play a game named the turtle and the turkey."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue35.wm")
            ...
            ElseIf MoveAtropos.Tag = 5076 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue36.wm")
            ElseIf MoveAtropos.Tag = 5250 Then
                shining.Enabled = False
                actor.Image = Nothing
                dialogue.ForeColor = Color.Red
                dialogue.Text = "I don't think you can get out of the hell. But if you" & vbCrLf & "completed, we still have a way to defeat you."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue37.wm")
            ElseIf MoveAtropos.Tag = 5425 Then
                dialogue.Text = "And soon you will know the real source of their" & vbCrLf & "tragedies. The same to the rooster."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue38.wm")
            ...
            ElseIf MoveAtropos.Tag = 5665 Then
                ...
                MoveAtropos.Enabled = False
                PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image8.wm")
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound51.wm")
            ElseIf MoveAtropos.Tag = 5666 Then
                dialogue.Text = "They tragedies come from their pursuit of illusive" & vbCrLf & "happiness."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue39.wm")
            ...
            ElseIf MoveAtropos.Tag = 5801 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue40.wm")
            ...
            ElseIf MoveAtropos.Tag = 5901 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue41.wm")
            ...
            ElseIf MoveAtropos.Tag = 5976 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue42.wm")
            ...
            ElseIf MoveAtropos.Tag = 6026 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue43.wm")
            ElseIf MoveAtropos.Tag = 6125 Then
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound54.wm")
                blocker68_3.Visible = True
            ...
            ElseIf MoveAtropos.Tag = 6126 Then
                dialogue.Text = "Hello, I'm the god of Mr.Duck's pool, I know you are" & vbCrLf & "going to get some water from the pool."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue44.wm")
            ...
            ElseIf MoveAtropos.Tag = 6390 Then
                dialogue.Text = "There is the dilute sulphuric acid, you must topple all" & vbCrLf & "of them to the pool, then you can get it activated."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue45.wm")
            ...
            ElseIf MoveAtropos.Tag = 6550 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue46.wm")
            ...
            ElseIf MoveAtropos.Tag = 6651 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue47.wm")
            ...
            ElseIf MoveAtropos.Tag = 6776 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue48.wm")
            ...
            ElseIf MoveAtropos.Tag = 6851 Then
                dialogue.Visible = False
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image25.wm")
            ElseIf MoveAtropos.Tag = 6875 Then
                dialogue.Visible = True
                dialogue.ForeColor = Color.Yellow
                dialogue.Text = "Let me have a look."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue49.wm")
            ElseIf MoveAtropos.Tag = 6975 Then
                dialogue.Text = "Oh my god! What the hell of it!"
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue50.wm")
            ElseIf MoveAtropos.Tag = 7100 Then
                dialogue.Text = "It's hellish difficult!!"
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue51.wm")
            ElseIf MoveAtropos.Tag = 7175 Then
                MoveAtropos.Enabled = False
                MsgBox("Originally that so-called ""pool god"" is the witch! However, now is a good chance to attack the witch.", 0, "Attack!")
                Hide()
                Form7.Show()
                DeathFlagNum = 2
                ...
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image10.wm")
            ElseIf MoveAtropos.Tag = 7176 Then
                DeathFlagNum = 3
                shining.Enabled = True
            ElseIf MoveAtropos.Tag = 7225 Then
                dialogue.ForeColor = Color.Red
                dialogue.Text = "She is just my minimum creation, and she is not" & vbCrLf & "good at math. So you needn't be too happy."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue52.wm")
            ElseIf MoveAtropos.Tag = 7400 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue53.wm")
            ...
            ElseIf MoveAtropos.Tag = 7551 Then
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound39.wm")
                SendMessage("Rooster:" & vbCrLf & "Hello, adventurer. I'm exploring the palace.", 17, "I have something important to tell you.")
                MoveAtropos.Enabled = False
            ElseIf MoveAtropos.Tag = 7552 Then
                dialogue.Visible = True
                dialogue.ForeColor = Color.Red
                dialogue.Text = "He is doomed to death. You cannot change his" & vbCrLf & "destiny."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue54.wm")
            ...
            ElseIf MoveAtropos.Tag = 7651 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue55.wm")
            ...
            ElseIf MoveAtropos.Tag = 7775 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound3.wm")
                Disappear2()
                PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image28.wm")
            ...
            ElseIf MoveAtropos.Tag = 7826 Then
                ...
                dialogue.Text = "*scream*"
                actor.Image = Nothing
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue56.wm")
            ElseIf MoveAtropos.Tag = 7875 Then
                MoveAtropos.Enabled = False
                dialogue.Visible = False
                SendMessage("*scream* (seems to come from the palace)", 22, "Probably is Atropos! Rush to Aurora's palace at once!")
            ElseIf MoveAtropos.Tag = 7900 Then
                dialogue.Visible = True
                dialogue.ForeColor = Color.Red
                dialogue.Text = "Look at my new creation. The positive negative cow!"
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue57.wm")
            ElseIf MoveAtropos.Tag = 8025 Then
                dialogue.Text = "Come up, my cow!"
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue58.wm")
            ElseIf MoveAtropos.Tag = 8075 Then
                MoveAtropos.Enabled = False
                dialogue.ForeColor = Color.Yellow
                dialogue.Text = "Click the cow to start battle." & vbCrLf & "(You can use item to suck up negative gas of cow)"
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\battler18.wm")
                If Not mute.Checked Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound35.wm")
                DeathFlagNum = 7
            ElseIf MoveAtropos.Tag = 8076 Then
                dialogue.Visible = True
                dialogue.Text = "I'm Aurora's ghost, I was once thrown to Mr.Duck" & vbCrLf & "function soup by Atropos."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue59.wm")
            ...
            ElseIf MoveAtropos.Tag = 8315 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue60.wm")
            ElseIf MoveAtropos.Tag = 8440 Then
                dialogue.Text = "The only thing I can give you is the turtle. I hope it" & vbCrLf & "can help you a lot."
            ...
            ElseIf MoveAtropos.Tag = 8530 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue61.wm")
            ...
            ElseIf MoveAtropos.Tag = 8701 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue62.wm")
            ...
            ElseIf MoveAtropos.Tag = 8975 Then
                dialogue.ForeColor = Color.Red
                dialogue.Text = "She is just my minimum creation. No matter what" & vbCrLf & "happens, the reality can never be changed."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue63.wm")
            ...
            ElseIf MoveAtropos.Tag = 9151 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue64.wm")
            ElseIf MoveAtropos.Tag = 9250 Then
                dialogue.Text = "Look at these stupid mortals. They're always" & vbCrLf & "torturing, slaying each other."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue65.wm")
            ElseIf MoveAtropos.Tag = 9375 Then
                dialogue.Text = "Humans are developing rapidly. But under the" & vbCrLf & "control of their lust,"
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue66.wm")
            ...
            ElseIf MoveAtropos.Tag = 9550 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue67.wm")
            ElseIf MoveAtropos.Tag = 9675 Then
                dialogue.Text = "I show them the consequence, to prohibit them from" & vbCrLf & "making their stupid destruction."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue68.wm")
            ...
            ElseIf MoveAtropos.Tag = 9875 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue69.wm")
            ...
            ElseIf MoveAtropos.Tag = 10100 Then
                dialogue.Visible = False
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image26.wm")
            ...
            ElseIf MoveAtropos.Tag = 10120 Then
                PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image33.wm")
            ...
            ElseIf MoveAtropos.Tag = 10150 Then
                SetHeight(479, -1)
                music.Ctlcontrols.stop()
                PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image34.wm")
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound32.wm")
            ...
            ElseIf MoveAtropos.Tag = 10251 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue70.wm")
            ElseIf MoveAtropos.Tag = 10350 Then
                dialogue.Text = ""
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image35.wm")
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound19.wm")
            ElseIf MoveAtropos.Tag = 10375 Then
                dialogue.Text = "Because of Atropos's power, I can not revive."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue71.wm")
            ...
            ElseIf MoveAtropos.Tag = 10525 Then
                dialogue.Text = "Thank you for your help. I hope there will be the day" & vbCrLf & "when we destroy Atropos."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue72.wm")
            ...
            ElseIf MoveAtropos.Tag = 10626 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue74.wm")
            ElseIf MoveAtropos.Tag = 10710 Then
                dialogue.Text = "I will change you to a big rock."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue75.wm")
            ElseIf MoveAtropos.Tag = 10800 Then
                dialogue.Text = "Look at my eyes."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue76.wm")
            ElseIf MoveAtropos.Tag = 10875 Then
                DeathFlagNum = 12
                dialogue.Text = ""
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image37.wm")
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound25.wm")
            ...
            ElseIf MoveAtropos.Tag = 11000 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue78.wm")
            ...
            ElseIf MoveAtropos.Tag = 11075 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue77.wm")
            ElseIf MoveAtropos.Tag = 11150 Then
                dialogue.Visible = False
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image38.wm")
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound34.wm")
            ...
            ElseIf MoveAtropos.Tag = 11176 Then
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue79.wm")
            ElseIf MoveAtropos.Tag = 11310 Then '√
                dialogue.Text = "These mortals're making fallacies one by one." & vbCrLf & "Their insistences are completely wrong."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue80.wm")
            ElseIf MoveAtropos.Tag = 11485 Then '√
                dialogue.Text = "And the effect will be the opposite."
            ElseIf MoveAtropos.Tag = 11550 Then '√
                dialogue.Text = "Their lust drives them to seek for their happiness." & vbCrLf & "But what means their happiness?"
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue81.wm")
            ...
            ElseIf MoveAtropos.Tag = 11800 Then '√
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue82.wm")
            ElseIf MoveAtropos.Tag = 11915 Then '√
                dialogue.Text = "Their persuit of happiness are all illusive. Their" & vbCrLf & "opinions are distorted."
            ElseIf MoveAtropos.Tag = 12050 Then '√
                dialogue.Text = "These mortals're really mournful. Because their" & vbCrLf & "absurd persuit of happiness will only bring sadness..."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue83.wm")
            ElseIf MoveAtropos.Tag = 12270 Then '√
                dialogue.Text = "You know all these facts, because you're also one" & vbCrLf & "of these mortals."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue84.wm")
            ...
            ElseIf MoveAtropos.Tag = 12480 Then '√
                dialogue.Text = "But you don't think them stupid. Because you're" & vbCrLf & "cheated. Now you're stupid too."
            ElseIf MoveAtropos.Tag = 12630 Then '√
                dialogue.Text = "You now intruded into my Destiny Temple. So I" & vbCrLf & "must destroy you."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue85.wm")
            ElseIf MoveAtropos.Tag = 12790 Then '√
                timebar.Value = 0
                timebar.Maximum = 150
                timebar.Visible = True
                dialogue.Visible = False
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image39.wm")
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound34.wm")
            ...
            ElseIf MoveAtropos.Tag = 12991 Then '√
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image2.wm")
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound62.wm")
            ElseIf MoveAtropos.Tag = 13000 Then '√
                ...
                timebar.Visible = False
                dialogue.Visible = True
                dialogue.Text = "What! You find the artifact!" & vbCrLf & "But I don't believe that you can get a good result-"
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue86.wm")
            ...
            ElseIf MoveAtropos.Tag = 13245 Then '√
                dialogue.Text = "I'll check your result on the Internet, then you have" & vbCrLf & "no way to cheat me anymore."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue87.wm")
            ElseIf MoveAtropos.Tag = 13380 Then '√
                dialogue.Visible = False
                timebar.Value = 0
                timebar.Maximum = 100
                timebar.Visible = True
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image40.wm")
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound57.wm")
            ...
            ElseIf MoveAtropos.Tag = 13480 Then '√
                ...
                If Unlocked.Items.Contains("freeze score") Then
                    ...
                    If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue90.wm")
                Else
                    dialogue.Text = "Your result is false! You originally had gotten" & vbCrLf & "flunked. The artifact is useless now."
                    If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue88.wm")
                End If
            ElseIf MoveAtropos.Tag = 13635 And Unlocked.Items.Contains("freeze score") = False Then '√
                dialogue.Visible = False
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image41.wm")
            ElseIf MoveAtropos.Tag = 13660 And Unlocked.Items.Contains("freeze score") = False Then '√
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image42.wm")
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound62.wm")
            ...
            ElseIf MoveAtropos.Tag = 13600 And Unlocked.Items.Contains("freeze score") Then '√
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue91.wm")
            ...
            ElseIf MoveAtropos.Tag = 13790 Then '√
                dialogue.Visible = True
                dialogue.ForeColor = Color.Red
                dialogue.Text = "Here is it. Solve it in one minute! it's the duck" & vbCrLf & "function. How can you solve it?"
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue92.wm")
            ...
            ElseIf MoveAtropos.Tag = 14010 Then
                ...
                GroupBox4.Location = New Point((PictureBox3.Left + PictureBox3.Width - GroupBox4.Width) / 2, (PictureBox3.Top + PictureBox3.Height - GroupBox4.Height) / 2)
            ...
            ElseIf MoveAtropos.Tag = 15210 Then '√
                ...
                dialogue.Visible = True
                dialogue.Text = "You can't solve it! So your exam paper is false." & vbCrLf & "Your artifact loses its effect!"
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue93.wm")
            ElseIf MoveAtropos.Tag = 15400 Then ' resume
                Unlocked.Items.Remove("freeze score")
                MoveAtropos.Tag = 13634
            ElseIf MoveAtropos.Tag = 15401 Then
                dialogue.Visible = True
                dialogue.Text = "Not so easy, let's resume. Solve this physics problem." & vbCrLf & "These problems are all on your exam paper,"
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue100.wm")
            ElseIf MoveAtropos.Tag = 15625 Then
                dialogue.Text = "as long as you can not solve one of them, your" & vbCrLf & "artifact will lose its effect."
            ...
            ElseIf MoveAtropos.Tag = 18200 Then '√
                dialogue.Visible = True
                dialogue.Text = "It seems your preparation is enough. But the next" & vbCrLf & "problem surely will defeat you,"
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue101.wm")
            ...
            ElseIf MoveAtropos.Tag = 24476 Then '√
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue94.wm")
            ElseIf MoveAtropos.Tag = 24600 Then '√
                dialogue.Text = "Come out, my creation. Mr.Duck phantom!"
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue95.wm")
            ElseIf MoveAtropos.Tag = 24725 Then
                dialogue.Visible = False
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image44.wm")
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound28.wm")
            ElseIf MoveAtropos.Tag = 24775 Then '√
                ...
                If items.Items.Contains("duck vector launcher") Then
                    ...
                    RefreshItems()
                    If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound60.wm")
                    actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image45.wm")
                ...
                Else
                    Hide()
                    Form7.Show()
                    Form7.initialization(shield_level, weapon_level, 0, 350 + shield_level * 150, 775, 22, 150, 110, 1000, 950)
                    music.settings.setMode("loop", True)
                    music.URL = My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\music8.wm"
                End If
            ...
            ElseIf MoveAtropos.Tag = 24777 Then '√
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue97.wm")
            ...
            ElseIf MoveAtropos.Tag = 24916 Then '√
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue96.wm")
            ElseIf MoveAtropos.Tag = 25035 Then '√
                dialogue.Text = "Now it's the time for us to start our final battle."
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue98.wm")
            ...
            ElseIf MoveAtropos.Tag = 25186 Then '√
                ...
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue99.wm")
        ...
        ElseIf actor.Tag = 1 Then
            ...
            If actor.Top >= Height Then
                ...
                ElseIf MoveAtropos.Tag = 10625 Then
                    ...
                    If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\dialogue73.wm")
                    MoveAtropos.Enabled = True
                ElseIf MoveAtropos.Tag = 11175 Then
                    actor.Visible = False
                    MoveAtropos.Enabled = False
        ...
        End If
    End Sub
    Public Function ChangeToTime(ByVal number As Integer)
    ...
    Public Sub RefreshItems()
        ...
        Next
    End Sub
    Private Function GetPictureCode(ByVal Name_ As String)
    ...
    Private Sub box28_1_Click(sender As Object, e As EventArgs) Handles box28_1.Click
        ...
        End If
    End Sub
    Friend Sub RemoveOut(ByVal thing As Control)
        thing.Visible = False
    ...
    Private Function SelectedItemIs(Optional ByVal itemname As String = "Default")
        ...
        End If
    End Function
    Private Sub UseItem(ByVal target As Control, code As Integer)
        Dim Selected As Boolean = False
        Dim SelectedItem_ As PictureBox
        For i As Integer = 0 To 4
            If ItemBox(i).BackColor = Color.Yellow Then
            ...
            If (MoveTop > -10 And MoveTop < 10) And (MoveLeft > -10 And MoveLeft < 10) Then
                ...
                ElseIf Not MovingItem.Tag = "Use" Then
                    ...
                    If MP3mixture Then
                        ...
                        actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image22.wm")
                        DeathFlagNum = 5
                        actor.Visible = True
                        dialogue.Visible = True
                        actor.Tag = 0
    ...
    Private Sub Affect(ByVal code As Integer)
        If code = 0 Then
            ...
            If Not mute.Checked Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound10.wm")
        ElseIf code = 1 Then
            RemoveOut(lock27_1)
            RemoveOut(place27_2)
            AddTip("The rocket is launched out and it destroyed the gate of Aurora palace.", True)
            If Not mute.Checked Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound32.wm")
        ElseIf code = 2 Then
            RemoveOut(lock26_1)
        ...
        ElseIf code = 3 Then
            ...
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound42.wm")
        ElseIf code = 4 Then
            RemoveOut(lock29_1)
        ...
        ElseIf code = 5 Then
            ...
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound14.wm")
        ElseIf code = 6 Then
            DeathFlag = True
            Scene011appears()
            music.settings.volume = BackgroundVolume
        ...
        ElseIf code = 12 Then
            backward.Visible = False
            If Not mute.Checked Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound10.wm")
            actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image7.wm")
            SendMessage("Tarecgosa:" & vbCrLf & "Stupid mortal! You dare to violate your goddess!", 5, "I will defeat you!")
        ElseIf code = 13 Then
            RemoveOut(lock44_4)
        ...
        ElseIf code = 15 Then
            ...
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound49.wm")
        ElseIf code = 16 Then
        ...
        ElseIf code = 20 Then
            If PictureBox3.Tag = 28 Then
                ...
                actor.Top = Height
                MoveSpeed = 2
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image23.wm")
                actor.Visible = True
                dialogue.Visible = True
                dialogue.Text = ""
                dialogue.ForeColor = Color.Yellow
        ...
        ElseIf code = 21 Then
            ...
            PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image24.wm")
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound56.wm")
            DeathTime.Tag = 0
        ...
        ElseIf code = 23 Then
            ...
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound59.wm")
        ElseIf code = 24 Then
            RemoveOut(lock69_2)
        ...
        ElseIf code = 37 Then
            ...
            actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\battler20.wm")
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound49.wm")
        ...
        ElseIf code = 38 Then
            ...
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound29.wm")
        ElseIf code = 39 Then
            PictureBox3.Tag = 41
            PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image30.wm")
            AddTip("You put the magical colloid into the mould.")
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound13.wm")
        ElseIf code = 40 Then
            PictureBox3.Tag = 42
            PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image31.wm")
        ...
        ElseIf code = 48 Then
            ...
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound20.wm")
        ElseIf code = 49 Then
            DrawerAffectTarget.Image = Nothing
            DrawerAffectTarget.Tag = -1
            GainItem(DrawerAffectTarget, "eraser")
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound50.wm")
        ElseIf code = 50 Then
        ...
        ElseIf code = 52 Then
            ...
            Disappear2()
            actor.Top = Height
            actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image32.wm")
            dialogue.Visible = False
            actor.Visible = True
            MoveSpeed = 2
        ...
        ElseIf code = 58 Then
            ...
            Form17.scoreurl = selectable.Substring(0, 3) & "." & selectable.Substring(3, 1) & "." & selectable.Substring(4, 3) & "." & selectable.Substring(7, 3) & ":8080"
        ElseIf code = 59 Then
        ...
        End If
    End Sub
    Friend Sub AddTip(ByVal content As String, Optional important As Boolean = False)
        TipBox.Text = content
    ...
    Private Sub arrow33_1_Click(sender As Object, e As EventArgs) Handles arrow33_1.Click
        ...
        ElseIf backward.Tag = 108 Then
            If MsgBox("Go through this door, you'll have your final battle with Atropos." & vbCrLf & "Are you ready?", vbYesNo, "Last battle") = vbYes Then
                Scene084appears()
                actor.Top = Height
                actor.Visible = True
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image2.wm")
        ...
        Else
            ...
            If PictureBox3.Tag = 4 Then
                ...
                actor.Visible = True
                dialogue.Visible = False
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image5.wm")
                MoveSpeed = 3
                MoveAtropos.Enabled = True
            End If
        End If
    ...
    Private Sub water35_2_Click(sender As Object, e As EventArgs) Handles water35_2.Click
        ...
        Else
            If SelectedItemIs("bottle") Then
                ...
                ElseIf PictureBox3.Tag = 30 Then
                    If MsgBox("The pool god asked you to dump dilute sulphuric acid to the pool to activate it before getting the water, are you sure you still want to get the water without activating it?", vbYesNo, "Confirm") = vbYes Then
                        PictureBox3.Tag = 31
                        UseItem(water35_2, 20)
                    Else
                        deselect()
        ...
        End If
    End Sub
    Private Sub Mresponse_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles Mresponse.LinkClicked
        If ResponseCode = 0 Then
            SendMessage("Prince frog:" & vbCrLf & "As you see, I'm in Mr.Duck theme park, because our palace is occupied by Tarecgosa.", 1, "Who is that ""Tarecgoda""?")
        ElseIf ResponseCode = 1 Then
            SendMessage("Prince frog:" & vbCrLf & "Tarecgosa, originally was the goddess of Lamouis, before a few years, she had gone far away. However, then she came back with evil.", 2, "What happened?")
        ElseIf ResponseCode = 2 Then
            SendMessage("Prince frog:" & vbCrLf & "Things will come out when we defeat her. She now is in palace, I give you the key, but you cannot get inside.", 3, "Why?")
        ElseIf ResponseCode = 3 Then
            SendMessage("Prince frog:" & vbCrLf & "She'll catch you. But there is a disadvantage: she has been extremely afraid of Corona Fire. If you can get that fire then she can be defeated.", 4, "I know. Thank you.")
        ElseIf ResponseCode = 4 Then
        ...
        ElseIf ResponseCode = 5 Then
            SendMessage("Tarecgosa:" & vbCrLf & "I will tear you up with my hands, then you will know your stupid fire useless.", 6, "To battle.")
        ...
        ElseIf ResponseCode = 9 Then
            PictureBox3.Tag = 28
            SendMessage("Just now I saw the witch making some spell on a rock, I tried to stop her, but then I was defeated by the witch, so I have to hide underwater.", 10, "I'm sorry to hear it.")
        ElseIf ResponseCode = 10 Then
            SendMessage("It's not serious. I've found the way defeating the witch, here is it. You give this Mr.Duck math workbook to the witch when you see her next time.", 11, "What's the use of it?")
        ElseIf ResponseCode = 11 Then
            SendMessage("The witch surely will be confused when she looks on the difficult sums on the workbook, then she'll be dizzy, and then she is being defeated.", 12, "I know, thank you a lot.")
        ElseIf ResponseCode = 12 Then
            SendMessage("You're welcome. The witch is in a small house on the top of Thorn Mountain, good luck, now I should go.", 13, "Ok.")
        ...
        ElseIf ResponseCode = 14 Then
            SendMessage("A saw! Now we can saw the thorns on second floor of Thorn Mountain! Then we can find that witch on the mountain.", 15, "I have just defeated the witch.")
        ElseIf ResponseCode = 15 Then
            SendMessage("Fantastic! I had told you the great use of Mr.Duck's math workbook, it is effected! I hope your journey can be successful.", 16, "Thank you.")
        ...
        ElseIf ResponseCode = 17 Then
            If Unlocked.Items.Contains("defeat witch") Then
                SendMessage("Rooster:" & vbCrLf & "What thing?", 18, "The god of destiny, Atropos is now eager to kill you.")
            Else
                SendMessage("Rooster:" & vbCrLf & "What thing?", 19, "A witch'll change to beautiful girl to charm you, then kill you.")
            End If
        ElseIf ResponseCode = 18 Then
            SendMessage("Rooster:" & vbCrLf & "I know Atropos. But how can I defend?", 19, "Atropos may create something to charm you, then kill you.")
        ElseIf ResponseCode = 19 Then
            SendMessage("Rooster:" & vbCrLf & "Atropos once killed our king by this way, she controlled Tarecgosa to charm and kill the king.", 20)
    ...
    Private Sub arrow32_2_Click(sender As Object, e As EventArgs) Handles arrow32_2.Click
        ...
        If DeathFlag Then
            Disappear2()
            PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image3.wm")
            DeathTime.Enabled = True
        ...
        ElseIf backward.Visible And backward.Tag = 60 Then
            ...
            ElseIf PictureBox3.Tag = 24 Then
                ...
                shining.Enabled = True
                PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image8.wm")
                If Not mute.Checked Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound51.wm")
            End If
    ...
    Private Sub DeathTime_Tick(sender As Object, e As EventArgs) Handles DeathTime.Tick
        ...
        Else
            If DeathTime.Tag = 1 Then
                ...
                music.Ctlcontrols.stop()
                If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound32.wm")
                PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image4.wm")
            ElseIf DeathTime.Tag = 3 Then
                DeathTime.Enabled = False
    ...
    Private Sub go_back_Click(sender As Object, e As EventArgs) Handles backward.Click
        ...
        If backward.Tag = 26 Then
            ...
            ElseIf SelectedItemIs("battery") Then
                If MsgBox("The battery can give energy to the time machine. But you haven't finish your mission currently, do you still want to do it?", vbYesNo, "charge") = vbYes Then
                    UseItem(backward, 6)
                Else
                    deselect()
                End If
...
cow_battle:
        ...
        ElseIf MoveAtropos.Tag > 11176 And MoveAtropos.Tag <= 12790 Then
            If SelectedItemIs("XuTianhao artifact") Or SelectedItemIs("XuTianhao artifact -1") Or SelectedItemIs("XuTianhao artifact -2") Then
                deselect()
                AddTip("Use it later.")
            End If
        ElseIf MoveAtropos.Tag > 12790 And MoveAtropos.Tag < 12940 Then
...
target_:
    ...
    End Sub
    Friend Sub SendMessage(ByVal content As String, code As Integer, Optional response As String = "Next.")
        ResponseCode = code
    ...
    Private Sub shining_Tick(sender As Object, e As EventArgs) Handles shining.Tick
        ...
        ElseIf PictureBox3.Tag = 37 Then
            shining.Tag += 1
            If arrow41_1.BackColor = Color.Red Then arrow41_1.BackColor = Color.Transparent Else arrow41_1.BackColor = Color.Red
        ...
        ElseIf DeathFlagNum = 4 Then
            shining.Tag += 1
            If leg70_3.BackColor = Color.Red Then leg70_3.BackColor = Color.Transparent Else leg70_3.BackColor = Color.Red
            If shining.Tag >= 20 Then
                shining.Tag = 0
                shining.Enabled = False
        ...
        ElseIf PictureBox3.Tag = 18 Then
            ...
            Else
                ...
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image15.wm")
            End If
        ElseIf PictureBox3.Tag = 7 Or PictureBox3.Tag = 10 Or PictureBox3.Tag = 19 Or PictureBox3.Tag = 25 Or PictureBox3.Tag = 35 Or DeathFlagNum = 9 Or DeathFlagNum = 10 Or DeathFlagNum = 11 Or DeathFlagNum = 12 Then
            shining.Tag += 1
            If arrow41_3.Tag = 1 Then
                arrow41_3.Tag = 2
                PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image9.wm")
            Else
                arrow41_3.Tag = 1
                PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image8.wm")
            End If
    ...
    Private Sub arrow57_1_Click(sender As Object, e As EventArgs) Handles arrow57_1.Click
        ...
        Else
            If lock57_2.Visible Then
                ...
                ElseIf SelectedItemIs() Then
                    deselect()
                    If PictureBox3.Tag = 36 Then AddTip("You need vector arrow and bow, then combine them.") Else AddTip("×")
                Else
                    If PictureBox3.Tag = 36 Then AddTip("If you shoot vector arrow to the door, it will open.") Else AddTip("")
                End If
            Else
                Scene035appears()
            End If
        ...
        Else
            If Unlocked.Items.Contains(lock69_2.Name) Then
                ...
                If Not Unlocked.Items.Contains("find frog leg") Then
                    ...
                    If Not mute.Checked Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound25.wm")
                End If
            Else
                If SelectedItemIs("saw") Then
                    UseItem(lock69_2, 24)
    ...
    Private Sub chicken72_2_Click(sender As Object, e As EventArgs) Handles chicken72_2.Click
        If Enable() = False Then Exit Sub
        If Not mute.Checked Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound39.wm")
    ...
    Private Sub arrow79_1_Click(sender As Object, e As EventArgs) Handles arrow79_1.Click
        If backward.Visible And backward.Tag = 79 Then
            ...
            If PictureBox3.Tag = 34 Then
                ...
                MoveSpeed = 3
                actor.Visible = True
                actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image27.wm")
                actor.Tag = 2
                actor.Top = Height
    ...
    Private Sub letter82_2_Click(sender As Object, e As EventArgs) Handles letter82_2.Click
        ...
        shining.Tag = 0
        DeathFlagNum = 0
        actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image8.wm")
        If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound51.wm")
    End Sub
    ...
    Private Sub machine102_1_Click(sender As Object, e As EventArgs) Handles machine102_1.Click
        ...
        End If
    End Sub
    Function GenerateRandom(ByVal Length As Integer, strtemp As String) As String
    ...
    Private Sub drawtime_Tick(sender As Object, e As EventArgs) Handles drawtime.Tick
        ...
        For Each draweritem In Drawer
            ...
            End If
        Next
        If drawtime.Tag >= 300 AndAlso Not ChosenDrawer().name = PictureBox3.Name AndAlso Not ChosenDrawer.tag = 5 AndAlso (drawtime.Tag >= 400 OrElse GenerateRandom(1, "0,1,2") = 0) Then
            drawtime.Tag = 0
    ...
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        ...
        If items.Items.Contains("painting tool") Then
            ...
            items.Items.Add("carbolic stick")
        End If
        If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound61.wm")
    ...
    Private Sub statue_fault_Click(sender As Object, e As EventArgs) Handles statue_fault.Click
        ...
        If Not Unlocked.Items.Contains("defeat Medusa") Then
            ...
            MoveSpeed = 2
            actor.Top = Height
            actor.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image36.wm")
            dialogue.Visible = False
            actor.Visible = True
        ...
        Else
            ...
            If mute.Checked = False Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound63.wm")
        End If
    End Sub
    ...
    Private Sub answerbutton_Click(sender As Object, e As EventArgs) Handles answerbutton.Click
        ...
        End If
    End Sub
    Private Sub InsertText(ByVal char_ As String)
        Dim temp As Integer = answerbox.SelectionStart
    ...
    Private Sub PhysicsMain_Tick(sender As Object, e As EventArgs) Handles PhysicsMain.Tick
        ...
        End If
    End Sub
    Private Sub AffectOnDrawer(ByVal target As PictureBox)
    ...
    Private Sub dive64_1_Click(sender As Object, e As EventArgs) Handles dive64_1.Click
        ...
        If backward.Visible And backward.Tag = 86 Then
            ...
            Else
                ...
                backward.Tag = -1
                backward.Visible = True
                PictureBox3.Image = Image.FromFile(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\image" & Math.Max(29, PictureBox3.Tag - 11) & ".wm")
    ...
    Private Sub arrow54_1_Click(sender As Object, e As EventArgs) Handles arrow54_1.Click
        ...
        End If
    End Sub
    Private Function MixThings(ByVal target As PictureBox)
        If Enable() = False Then Return False
        Dim source As PictureBox
        For x As Integer = 0 To 4
            If ItemBox(x).BackColor = Color.Yellow Then source = ItemBox(x)
        Next
        If Unlocked.Items.Contains("recipe") And target.Tag.ToString.Split("/")(1) = "carbolic stick" And SelectedItemIs("chicken blood") Then
            Mix(source, target, "red stick")
            AddTip("You dip the stick into the blood.")
            Return True
        ElseIf Unlocked.Items.Contains("recipe") And target.Tag.ToString.Split("/")(1) = "chemistry test paper" And SelectedItemIs("red stick") Then
            Mix(source, target, "chemistry test paper (passed)", True)
            AddTip("The chemistry flunked test paper is rewritten.")
            Return True
        ElseIf Unlocked.Items.Contains("recipe") And target.Tag.ToString.Split("/")(1) = "physics test paper" And SelectedItemIs("red stick") Then
        ...
        ElseIf Unlocked.Items.Contains("recipe") And target.Tag.ToString.Split("/")(1) = "painting tool" And SelectedItemIs("chicken blood") Then
            Mix(source, target, "red stick")
        ...
        ElseIf target.Tag.ToString.Split("/")(1) = "XuTianhao artifact -2" And SelectedItemIs("physics test paper (passed)") Then
            Mix(source, target, "XuTianhao artifact -1")
        ElseIf target.Tag.ToString.Split("/")(1) = "XuTianhao artifact -2" And SelectedItemIs("chemistry test paper (passed)") Then
            Mix(source, target, "XuTianhao artifact -1")
        ElseIf target.Tag.ToString.Split("/")(1) = "XuTianhao artifact -1" And SelectedItemIs("physics test paper (passed)") Then
            Mix(source, target, "XuTianhao artifact")
        ElseIf target.Tag.ToString.Split("/")(1) = "XuTianhao artifact -1" And SelectedItemIs("chemistry test paper (passed)") Then
            Mix(source, target, "XuTianhao artifact")
        Else
            Return False
        End If
    End Function
    Private Sub Mix(ByVal source As PictureBox, ByVal target As PictureBox, ByVal resultant As String, Optional ByVal recycle As Boolean = False)
        MoveTarget = target
        MovingItem.SizeMode = PictureBoxSizeMode.Zoom
        ...
        MoveItem.Enabled = True
        MoveItem.Tag = 0
        If Not mute.Checked And Not actor.Visible Then My.Computer.Audio.Play(My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound50.wm")
    End Sub
    Private Sub answerbox_Click(sender As Object, e As EventArgs) Handles answerbox.Click
        ...
        End If
    End Sub
    Dim Blocks() As Label, MouseX As Integer, MouseY As Integer, MoveX1 As Double, MoveY1 As Double, MoveX2 As Double, MoveY2 As Double, TransportX As Double, Ground1 As Boolean = False, Ground2 As Boolean = False, Point01 As Single, Point02 As Single, EndTime As Single = 0, rCycleTime(1, 1) As Integer, rCyclingNumber(1, 1, 1) As Single, rCycled(1, 1) As Boolean, rAgain(1, 1) As Boolean
    ...
    Private Sub PhysicsAdd_Click(sender As Object, e As EventArgs) Handles PhysicsAdd.Click
        If Physics2Launch.Text = "Stop" And stabber.Size = New Size(15, 16) And PhysicsTemp1.Text <= 3 And Not PhysicsAdd.BackColor = Color.Yellow Then
    ...
    Private Sub MoveBomb_Tick(sender As Object, e As EventArgs) Handles MoveBomb.Tick
        If PhysicsBomb.Visible Then
            ...
            PhysicsBomb.Left = Math.Max(Math.Min(Physics2Ground.Right - PhysicsBomb.Width, Cursor.Position.X - Left - MouseX), Physics2Ground.Right / 2)
            PhysicsBomb.Top = Math.Min(Math.Max(Cursor.Position.Y - Top - MouseY, PhysicsTemp1.Top), Physics2Ground.Bottom - PhysicsBomb.Height)
            If PhysicsBomb.Bottom > block02.Top And PhysicsBomb.Top < block25.Bottom And PhysicsBomb.Right > block02.Left And PhysicsBomb.Left < block25.Right Then
                PhysicsBomb.BackColor = Color.Red
            Else
                PhysicsBomb.BackColor = Color.Black
            End If
        Else
            Dim Unable As Integer = 0
            For Each block In Blocks
                ...
                ElseIf block.Tag.ToString.Split(",")(0) = 5 Then
                    ...
                    block.Left -= Move
                End If
                If block.Bottom < startlabel.Top Or block.Top > Physics2Ground.Bottom Or block.Right < physicstemp2.Left Or block.Left > PhysicsTemp1.Right Then block.Visible = False
            Next
    ...
    Private Sub debug1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Blocks = {block01, block02, block03, block04, block05, block06, block07, block08, block09, block10, block11, block12, block13, block14, block15, block16, block17, block18, block19, block20, block21, block22, block23, block24, block25}
    End Sub
    ...
    Private Sub Physics2Main_Tick(sender As Object, e As EventArgs) Handles Physics2Main.Tick
        ...
        If Transporter.Left > -OneMeterPx * TransporterSpeed * TimeSet And Transporter.Left < OneMeterPx * TransporterSpeed * TimeSet Then Transporter.Left = PhysicsBlocker.Left - Transporter.Width
        '移动开关门
        ...
        Else
            Dim Vm1 As Double = Math.Pow(Math.Pow(MainBlock1.Tag.ToString.Split(",")(0), 2) + Math.Pow(MainBlock1.Tag.ToString.Split(",")(1), 2), 0.5)
            ...
            frontbar1.BackColor = Color.FromArgb(255 * frontbar1.Width / backbar1.Width, 255 * (1 - frontbar1.Width / backbar1.Width), 255 * (1 - frontbar1.Width / backbar1.Width))
        End If
        If frontbar2.Tag = -1 Then
            frontbar2.Text = "Out of range"
        Else
            Dim Vm2 As Double = Math.Pow(Math.Pow(MainBlock2.Tag.ToString.Split(",")(0), 2) + Math.Pow(MainBlock2.Tag.ToString.Split(",")(1), 2), 0.5)
            ...
            frontbar2.BackColor = Color.FromArgb(255 * frontbar2.Width / backbar2.Width, 255 * (1 - frontbar2.Width / backbar1.Width), 255 * (1 - frontbar2.Width / backbar2.Width))
        End If
        '移动两个物体
        ...
        If frontbar1.Text <> "Out of range" Then MainBlock1.Location = New Point(MainBlock1.Left + Int(RealX1), MainBlock1.Top + Int(RealY1))
        If frontbar2.Text <> "Out of range" Then MainBlock2.Location = New Point(MainBlock2.Left + Int(RealX2), MainBlock2.Top + Int(RealY2))
        '计算两个物体的加速度
        ...
        For Each object_ As Control In {MainBlock1, MainBlock2}
            ...
            If Forced(object_, MoverLeft, ForceDirection.FromUp) Or Forced(object_, MoverRight, ForceDirection.FromUp) Then
                '位于开关上
                power(1) -= gravity.Value
            ...
            If Forced(object_, Transporter, ForceDirection.FromUp) And object_.Left < PhysicsBlocker.Left Then
                ...
                If Physics_μ.Text.Split("=")(1) <> 0 Then
                    ...
                    Else
                        power(0) += Physics_μ.Text.Split("=")(1) * pressure * gravity.Value
                    End If
                    If PhysicsBomb.Visible AndAlso object_.Left > PhysicsBlocker.Left / 2 Then PhysicsRocket.Visible = True
                End If
            ...
            If Forced(object_, subobject, ForceDirection.FromUp) Then
                ...
                Else
                    power(1) -= object_.Tag.ToString.Split(",")(1) * rebounce
                End If
                If IsIgnorable(object_.Tag.ToString.Split(",")(0) - subobject.Tag.ToString.Split(",")(0), target, 0) Then
        ...
        '增加速度
        MainBlock1.Tag = MainBlock1.Tag.ToString.Split(",")(0) + acceleration(0, 0) * TimeSet & "," & MainBlock1.Tag.ToString.Split(",")(1) + acceleration(0, 1) * TimeSet
        MainBlock2.Tag = MainBlock2.Tag.ToString.Split(",")(0) + acceleration(1, 0) * TimeSet & "," & MainBlock2.Tag.ToString.Split(",")(1) + acceleration(1, 1) * TimeSet
        '检测超出边界
        ...
        End If
        '检测时间结束
        If (frontbar1.Text = "0" Or frontbar1.Text = "Out of range") And (frontbar2.Text = "0" Or frontbar2.Text = "Out of range") Then
            EndTime += TimeSet
            If EndTime >= 2 Then
                stabtime.Enabled = False
                Physics2Main.Enabled = False
                ...
                If MainBlock1.BackColor = Color.Yellow And MainBlock2.BackColor = Color.Yellow Then
                    ...
                    PhysicsInterval.Text = PhysicsInterval.Text.Split(".")(0) & "." & PhysicsInterval.Text.Split(".")(1).PadRight(2, "0")
                    PhysicsInterval.Text = Math.Abs(CType(PhysicsInterval.Text.Split(".")(0), Single)) & "." & PhysicsInterval.Text.Split(".")(1)
        ...
        End If
    End Sub
    Private Function Converted(ByVal control1 As Control, control2 As Control)
        If control1.Bottom >= control2.Top And control1.Bottom <= control2.Bottom And control1.Right >= control2.Left And control1.Right <= control2.Right Then
            Return True
        Else
            Return False
        End If
    ...
    ''' <returns></returns>
    Function Forced(ByVal object1 As Control, object2 As Control, Optional direction As ForceDirection = ForceDirection.Anyway)
        Dim AnywayCanSucceed As Boolean = False
        Dim half_completed As Boolean = False
...
next_stage:
        If half_completed Then
            ...
            forcer2 = object1
        End If
        If ((forcer1.Top >= forcer2.Top And forcer1.Top <= forcer2.Bottom) Or (forcer1.Bottom >= forcer2.Top And forcer1.Bottom <= forcer2.Bottom)) And ((forcer1.Left >= forcer2.Left And forcer1.Left <= forcer2.Right) Or (forcer1.Right >= forcer2.Left And forcer1.Right <= forcer2.Right)) Then AnywayCanSucceed = True
        If half_completed Then
            forcer1 = object1
            forcer2 = object2
        Else
        ...
        End If
    End Function
    Function IsIgnorable(ByVal Value As Single, BlockNum As Integer, xySpeed As Integer)
        ...
        If rCycled(BlockNum, xySpeed) = False Then
            If CheckingSpeed <> 0 Then
                ...
                Else
                    If rCyclingNumber(BlockNum, xySpeed, 0) <> CheckingSpeed Then rCyclingNumber(BlockNum, xySpeed, 1) = CheckingSpeed
                End If
            End If
        Else
            rAgain(BlockNum, xySpeed) = True
            rCycled(BlockNum, xySpeed) = False
            If Not (CheckingSpeed = rCyclingNumber(BlockNum, xySpeed, 0) Or CheckingSpeed = rCyclingNumber(BlockNum, xySpeed, 1)) Then
                rAgain(BlockNum, xySpeed) = True
                rCycled(BlockNum, xySpeed) = False
