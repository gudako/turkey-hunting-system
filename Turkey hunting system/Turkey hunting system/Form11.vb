Public Class Form11
    ...
    Public Sub start(picture_index As Integer, title_ As String, content_ As String, choice1 As String,
                     Optional choice2 As String = "", Optional choice3 As String = "")
        Form1.Hide()
        Show()
        code = picture_index
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ElseIf code = 10 Then
            MsgBox(
                "It was because that many students didn't submit homework which made the English teacher angry, so she set the corona ball to compel students doing the homework.",
                48, "The corona ball")
            Hide()
            Form7.Show()
        ...
        ElseIf code = - 6 Then
            If Question = 1 Then
                MsgBox(
                    "Chairman:" & vbCrLf & "[...] chooses C, sorry, it's wrong. It gains no point." & vbCrLf &
                    "We cannot eat a hen on that day.", 0, "No")
            ElseIf Question = 2 Then
                MsgBox(
                    "Chairman:" & vbCrLf & "[...] chooses C, sorry, it's wrong. It gains no point." & vbCrLf &
                    "The big smelly milk cow and turkey can breed a TurkCow.", 0, "No")
            ElseIf Question = 3 Then
                MsgBox(
                    "Chairman:" & vbCrLf & "[...] chooses C, sorry, it's wrong. It gains no point." & vbCrLf &
                    "Only sky shit turkey likes eating shit.", 0, "No")
            ...
            ElseIf Question = 5 Then
                ...
                Else
                    MsgBox(
                        "Chairman:" & vbCrLf & "[...] chooses C, sorry, it's wrong. It gains no point." & vbCrLf &
                        "The turkey surely has a nest.", 0, "No")
                End If
            ElseIf Question = 6 Then
                MsgBox(
                    "Chairman:" & vbCrLf & "[...] chooses C, sorry, it's wrong. It gains no point." & vbCrLf &
                    "Turkey's psychology is differ from human's.", 0, "No")
            End If
        ...
        ElseIf code = 22 Then
            ...
            Form6.start(
                "Big cow:" & vbCrLf &
                "Just now while I was giving milk, something bit me continuously. Then I looked like now.", 21)
        ElseIf code = - 7 Then
            If microscope.Value >= 90 Then
                ...
                content.Text =
                    "There're massive turkey eater worm eggs! They're small but still visible! It's the turkey eater worm bit our cow!"
                Button1.Text = "Oh!"
            Else
        ...
        ElseIf code = - 9 Then
            ...
            If Form1.witch_book Then _
                MsgBox(
                    "What the hell of the witch?? We have the witch's book, but can not understand its content at all.",
                    0, "Mystery")
            MsgBox("Though we do not know the truth, but the foremost thing is to catch the turkey.")
            Hide()
            Form1.Show()
            MsgBox("We've saved the cow, now we can go outside and catch the turkey. It's still near the lecture hall.",
                   0, "Resume hunting the turkey.")
        ElseIf code = 31 Then
        ...
        ElseIf code = 33 Then
            If Rnd() < 0.2 Then
                ...
                MsgBox(
                    "You heard something exploded." & vbCrLf &
                    "When you moved back your head, you saw the school building was on fire!", 0, "Fire")
                Hide()
                Form14.Show()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        ElseIf code = 13 Then
            try_to_avoid = True
            MsgBox("The murloc is so insane: You can hardly avoid." & vbCrLf & "·You get 60.00 damage.", 16,
                   "Impossible")
            Hide()
            Form7.Show()
            Form7.initialization(Form1.shield_level, Form1.weapon_level, 0, 300 + Form1.shield_level*150, 440, 4)
        ...
        ElseIf code = 21 Then
            ...
            MsgBox(
                "Chairman:" & vbCrLf &
                "Each one of you has a score table. In this part everyone gets ten questions to answer. When you correctly answer one question, gain 20 points, wrong answer does not deduct point.",
                0, "Chairman")
        ...
        ElseIf code = - 6 Then
            If Question = 1 Then
                MsgBox(
                    "Chairman:" & vbCrLf & "[...] chooses B, sorry, it's wrong. It gains no point." & vbCrLf &
                    "It's unreasonable to eat rooster, though it's also a type of chick.", 0, "No")
            ElseIf Question = 2 Then
            ...
            ElseIf Question = 4 Then
                MsgBox(
                    "Chairman:" & vbCrLf & "[...] chooses B, sorry, it's wrong. It gains no point." & vbCrLf &
                    "The turkey will hibernate while we're having Christmas.", 0, "No")
            ElseIf Question = 5 Then
                MsgBox(
                    "Chairman:" & vbCrLf & "[...] chooses B, sorry, it's wrong. It gains no point." & vbCrLf &
                    "The hen has nest in class, but the turkey does not.", 0, "No")
            ElseIf Question = 6 Then
                MsgBox("Chairman:" & vbCrLf & "[...] chooses B, correct! It gains 20 points.", 0, "Yes")
                match.Text += 20
            End If
        ...
        ElseIf code = 29 Then
            If Form1.items.Items.Contains("Mr.Duck's plank") Then
                If _
                    MsgBox("Do you want to upgrade Duck function by using Mr.Duck's plank?", vbYesNo, "Upgrade confirm") =
                    vbYes Then
                    If Form1.mute.Checked = False Then _
                        My.Computer.Audio.Play(
                            My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound19.wm")
                    MsgBox(
                        "Successfully upgraded!" & vbCrLf & "You get:" & vbCrLf & "The key to time machine," & vbCrLf &
                        "The key to Amber Nest," & vbCrLf & "Duck function+.", 0, "Upgrade!")
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        ElseIf code = - 6 Then
            ...
            ElseIf Question = 2 Then
                MsgBox(
                    "Chairman:" & vbCrLf & "[...] chooses A, sorry, it's wrong. It gains no point." & vbCrLf &
                    "Turkey can probably breed a hen.", 0, "No")
            ElseIf Question = 3 Then
                MsgBox(
                    "Chairman:" & vbCrLf & "[...] chooses A, sorry, it's wrong." & vbCrLf &
                    "I think the attraction completely useless.", 0, "No")
            ...
            ElseIf Question = 4 Then
                MsgBox(
                    "Chairman:" & vbCrLf & "[...] chooses A, sorry, it's wrong. It gains no point." & vbCrLf &
                    "You even didn't have caught it, how can you eat it at once? Impossible.", 0, "No")
            ElseIf Question = 5 Then
                If Form1.destroy_nest Then
                    MsgBox(
                        "Chairman:" & vbCrLf & "[...] chooses A, sorry, it's wrong. It gains no point." & vbCrLf &
                        "The nest has already been destroyed.", 0, "No")
                Else
                    MsgBox("Chairman:" & vbCrLf & "[...] chooses A, correct! It gains 20 points.", 0, "Yes")
                    match.Text += 20
                End If
            ElseIf Question = 6 Then
                MsgBox(
                    "Chairman:" & vbCrLf & "[...] chooses A, sorry, it's wrong. It gains no point." & vbCrLf &
                    "Biology helps you to research, but we need to hunt it.", 0, "No")
            End If
            ToQuestion(Question + 1)
        ElseIf code = 34 Then
    ...
    Private Sub ToQuestion(code As Integer)
        Question = code
        If code = 1 Then
        ...
        ElseIf code = 7 Then
            If Form1.mute.Checked = False Then _
                My.Computer.Audio.Play(
                    My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\temporary files\sound33.wm")
